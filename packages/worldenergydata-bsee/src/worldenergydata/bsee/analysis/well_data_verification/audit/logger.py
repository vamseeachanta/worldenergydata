...
class AuditLogger:
    ...
    def log_error(
        ...
        return self.log_event(
            event_type="ERROR", user_id=user_id, details=details, severity="error"
        )
    ...
    def log_warning(
        ...
        """
        details = {"message": warning_message, "context": context or {}}

        return self.log_event(
            event_type="WARNING", user_id=user_id, details=details, severity="warning"
        )
    ...
    def log_verification_complete(
        self, user_id: str, session_id: str, results: Dict[str, Any]
    ) -> AuditEvent:
        """
    ...
    def apply_retention_policy(self, days: int = 90):
        ...
        logger.info(
            f"Retention policy applied: removed {deleted.rowcount} events older than {days} days"
        )
    ...
    def export_audit_log(
        ...
        self.log_event(
            ...
            user_id="system",
            details={"output_path": str(output_path), "event_count": len(events)},
        )
    ...
    def close(self):
        ...
        self.log_event(event_type="AUDIT_LOGGER_CLOSE", user_id="system", details={})
        self.database.close()
