"""HSE Activity/Subactivity data definitions.

Pure data layer: dataclasses and builder functions for the 14-activity
HSE taxonomy. No registry or indexing logic — import from
activity_registry for that.
"""
