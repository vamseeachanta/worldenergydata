...
'''
    ...
    def generate_consolidated_suite(self, redundant_tests: List[str]) -> Dict[str, str]:
        ...
        if init_tests:
            consolidated_files['test_consolidated_init.py'] = self.consolidate_init_tests()
            
        if app_tests:
            consolidated_files['test_consolidated_application.py'] = self.consolidate_application_tests()
            
        if excel_tests:
            consolidated_files['test_consolidated_excel.py'] = self._generate_excel_tests()
