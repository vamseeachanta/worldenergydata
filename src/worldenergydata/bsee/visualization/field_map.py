...
VALID_COLOR_BY = frozenset(["geological_era", "operator", "water_depth", "production"])
...
_GOM_FIELD_CATALOG: list[dict] = [
    ...
    dict(
        ...
        operator="BP",
        cumulative_oil_bbl=525_000_000,
        cumulative_gas_mcf=900_000_000,
        peak_rate_bopd=200_000,
    ...
    dict(
        ...
        geological_era="miocene",
        operator="BP",
        cumulative_oil_bbl=710_000_000,
        cumulative_gas_mcf=1_200_000_000,
        peak_rate_bopd=250_000,
        first_production_year=2008,
        status="producing",
    ),
    dict(
        field_name="Mars",
        ...
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=950_000_000,
        cumulative_gas_mcf=2_000_000_000,
        peak_rate_bopd=220_000,
    ...
    dict(
        ...
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=280_000_000,
        cumulative_gas_mcf=800_000_000,
        peak_rate_bopd=100_000,
        first_production_year=2003,
        status="producing",
    ),
    dict(
        field_name="Auger",
        ...
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=400_000_000,
        cumulative_gas_mcf=900_000_000,
        peak_rate_bopd=90_000,
        first_production_year=1994,
        status="producing",
    ),
    dict(
        field_name="Ursa",
        ...
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=430_000_000,
        cumulative_gas_mcf=750_000_000,
        peak_rate_bopd=150_000,
        first_production_year=1999,
        status="producing",
    ),
    dict(
        field_name="Holstein",
        ...
        geological_era="miocene",
        operator="BP",
        cumulative_oil_bbl=190_000_000,
        cumulative_gas_mcf=400_000_000,
        peak_rate_bopd=55_000,
        first_production_year=2004,
        status="producing",
    ),
    dict(
        field_name="Shenzi",
        ...
        geological_era="miocene",
        operator="BHP",
        cumulative_oil_bbl=310_000_000,
        cumulative_gas_mcf=500_000_000,
        peak_rate_bopd=100_000,
        first_production_year=2009,
        status="producing",
    ),
    dict(
        field_name="Mad Dog",
        ...
        geological_era="miocene",
        operator="BP",
        cumulative_oil_bbl=360_000_000,
        cumulative_gas_mcf=600_000_000,
        peak_rate_bopd=130_000,
        first_production_year=2005,
        status="producing",
    ),
    dict(
        field_name="Great White",
        lat=27.0,
        lon=-90.5,
        water_depth_m=2700,
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=120_000_000,
        cumulative_gas_mcf=200_000_000,
    ...
    dict(
        ...
        lon=-91.5,
        water_depth_m=1259,
        geological_era="eocene",
        operator="BP",
        cumulative_oil_bbl=0,
        cumulative_gas_mcf=0,
        peak_rate_bopd=0,
        first_production_year=2099,
        status="inactive",
    ),
    dict(
        field_name="Anchor",
    ...
    dict(
        ...
        lon=-90.0,
        water_depth_m=2500,
        geological_era="oligocene",
        operator="Petrobras",
        cumulative_oil_bbl=65_000_000,
        cumulative_gas_mcf=120_000_000,
        peak_rate_bopd=35_000,
    ...
    dict(
        ...
        geological_era="paleocene",
        operator="Murphy",
        cumulative_oil_bbl=45_000_000,
        cumulative_gas_mcf=90_000_000,
        peak_rate_bopd=25_000,
        first_production_year=2012,
        status="producing",
    ),
    dict(
    ...
    dict(
        ...
        geological_era="paleocene",
        operator="Chevron",
        cumulative_oil_bbl=90_000_000,
        cumulative_gas_mcf=150_000_000,
        peak_rate_bopd=40_000,
        first_production_year=2014,
        status="producing",
    ),
    dict(
        field_name="Buckskin",
        ...
        geological_era="eocene",
        operator="Chevron",
        cumulative_oil_bbl=15_000_000,
        cumulative_gas_mcf=30_000_000,
        peak_rate_bopd=20_000,
    ...
    dict(
        field_name="Eugene Island",
        lat=28.5,
        lon=-91.5,
        water_depth_m=200,
        geological_era="pliocene",
        operator="Shell",
        cumulative_oil_bbl=600_000_000,
        cumulative_gas_mcf=5_000_000_000,
        peak_rate_bopd=60_000,
        first_production_year=1971,
        status="inactive",
    ),
    dict(
        field_name="Ship Shoal",
        lat=28.8,
        lon=-91.0,
        water_depth_m=120,
        geological_era="pliocene",
        operator="W&T Offshore",
        cumulative_oil_bbl=450_000_000,
        cumulative_gas_mcf=3_500_000_000,
        peak_rate_bopd=50_000,
        first_production_year=1968,
        status="inactive",
    ),
    dict(
        field_name="South Timbalier",
        lat=29.0,
        lon=-90.5,
        water_depth_m=90,
        geological_era="pliocene",
        operator="W&T Offshore",
        cumulative_oil_bbl=200_000_000,
        cumulative_gas_mcf=2_000_000_000,
        peak_rate_bopd=30_000,
        first_production_year=1965,
        status="decommissioned",
    ),
    dict(
        field_name="East Cameron",
        lat=29.2,
        lon=-92.0,
        water_depth_m=60,
        geological_era="pliocene",
        operator="Talos Energy",
        cumulative_oil_bbl=150_000_000,
        cumulative_gas_mcf=1_500_000_000,
        peak_rate_bopd=20_000,
        first_production_year=1960,
        status="inactive",
    ),
    dict(
        field_name="West Cameron",
        lat=29.3,
        lon=-92.5,
        water_depth_m=50,
        geological_era="pliocene",
        operator="Talos Energy",
        cumulative_oil_bbl=80_000_000,
        cumulative_gas_mcf=800_000_000,
        peak_rate_bopd=12_000,
        first_production_year=1958,
        status="decommissioned",
    ),
    dict(
        field_name="Vermilion",
        lat=29.1,
        lon=-92.3,
        water_depth_m=80,
        geological_era="pliocene",
        ...
        cumulative_oil_bbl=120_000_000,
        cumulative_gas_mcf=1_200_000_000,
        peak_rate_bopd=18_000,
        first_production_year=1962,
        status="inactive",
    ),
    dict(
        field_name="Mississippi Canyon 20",
        lat=28.9,
        lon=-89.4,
        water_depth_m=350,
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=75_000_000,
        cumulative_gas_mcf=150_000_000,
        peak_rate_bopd=30_000,
        first_production_year=1990,
        status="inactive",
    ),
    dict(
        field_name="Green Canyon 18",
        lat=27.8,
        lon=-91.2,
        water_depth_m=600,
        geological_era="miocene",
    ...
    dict(
        ...
        geological_era="miocene",
        operator="BP",
        cumulative_oil_bbl=130_000_000,
        cumulative_gas_mcf=350_000_000,
        peak_rate_bopd=45_000,
        first_production_year=1994,
        status="producing",
    ),
    dict(
        ...
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=115_000_000,
        cumulative_gas_mcf=280_000_000,
        peak_rate_bopd=48_000,
        first_production_year=2001,
        status="producing",
    ),
    dict(
        field_name="Caesar",
        ...
        geological_era="miocene",
        operator="BP",
        cumulative_oil_bbl=55_000_000,
        cumulative_gas_mcf=100_000_000,
        peak_rate_bopd=30_000,
        first_production_year=2012,
        status="producing",
    ),
    dict(
        ...
        geological_era="miocene",
        operator="Murphy",
        cumulative_oil_bbl=70_000_000,
        cumulative_gas_mcf=120_000_000,
        peak_rate_bopd=28_000,
        first_production_year=2011,
        status="producing",
    ),
    dict(
        field_name="Kodiak",
        ...
        operator="BP",
        cumulative_oil_bbl=80_000_000,
        cumulative_gas_mcf=140_000_000,
        peak_rate_bopd=35_000,
        first_production_year=2010,
        status="producing",
    ),
    ...
    dict(
        field_name="Heidelberg",
        lat=26.9,
        lon=-91.5,
        water_depth_m=1615,
        geological_era="miocene",
        operator="Anadarko",
        cumulative_oil_bbl=50_000_000,
        cumulative_gas_mcf=80_000_000,
        peak_rate_bopd=35_000,
        first_production_year=2016,
        status="producing",
    ),
    dict(
        ...
        operator="Anadarko",
        cumulative_oil_bbl=90_000_000,
        cumulative_gas_mcf=160_000_000,
        peak_rate_bopd=45_000,
        first_production_year=2015,
        status="producing",
    ),
    dict(
        field_name="Gunflint",
        ...
        geological_era="miocene",
        operator="Murphy",
        cumulative_oil_bbl=40_000_000,
        cumulative_gas_mcf=70_000_000,
        peak_rate_bopd=18_000,
        first_production_year=2016,
        status="producing",
    ),
    dict(
        field_name="Marmalard",
        lat=28.8,
        lon=-89.1,
        water_depth_m=400,
        geological_era="miocene",
        operator="Murphy",
        cumulative_oil_bbl=30_000_000,
        cumulative_gas_mcf=60_000_000,
        peak_rate_bopd=12_000,
    ...
    dict(
        ...
        geological_era="miocene",
        operator="ExxonMobil",
        cumulative_oil_bbl=20_000_000,
        cumulative_gas_mcf=40_000_000,
        peak_rate_bopd=15_000,
        first_production_year=2017,
        status="producing",
    ),
    dict(
    ...
    dict(
        field_name="Swordfish",
        lat=28.0,
        lon=-91.4,
        water_depth_m=1100,
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=25_000_000,
        cumulative_gas_mcf=50_000_000,
        peak_rate_bopd=10_000,
        first_production_year=2014,
        status="producing",
    ),
    dict(
        ...
        geological_era="miocene",
        operator="Shell",
        cumulative_oil_bbl=60_000_000,
        cumulative_gas_mcf=100_000_000,
        peak_rate_bopd=30_000,
        first_production_year=2023,
        status="producing",
    ),
    dict(
        field_name="Whale",
...
def _compute_bubble_sizes(
    ...
    return [min_size + (v / max_val) * (max_size - min_size) for v in values]
...
def _get_color_sequence(fields: list[FieldRecord], color_by: str) -> list[str]:
    ...
    if color_by == "production":
        ...
        return [f"rgb(200, {int(200 - 180 * v / max_v)}, 50)" for v in vals]
...
class GomFieldMap:
    ...
    def plot_production_timeline(
        ...
        if production_df is None:
            ...
            oil_values = [peak * (1 / (1 + 0.3 * i) ** 2) for i in range(len(years))]
