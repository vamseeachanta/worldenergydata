...
from assetutilities.common.database import (
    get_db_connection,
...
data_from_db = [
    {
        ...
        "filename": os.path.join(
            script_working_dir, "data", "postgresql", "sql", "bsee.field_summary.sql"
        ),
    },
    {
        "label": "gom_fields",
        "filename": os.path.join(
            script_working_dir, "data", "postgresql", "sql", "bsee.get_gom_fields.sql"
        ),
    },
    {
        "label": "well_locations",
        "filename": os.path.join(
            script_working_dir, "data", "postgresql", "sql", "bsee.well_locations.sql"
        ),
    },
    {
        ...
        "filename": os.path.join(
            ...
            "postgresql",
            "sql",
            "bsee.well_location_and_production.sql",
        ),
    },
    {
        ...
        "filename": os.path.join(
            ...
            "postgresql",
            "sql",
            "bsee.well_summary_high_level.sql",
        ),
    },
    {
    ...
    },
    {
        ...
        "filename": os.path.join(
            ...
            "postgresql",
            "sql",
            "bsee.well_construction.sql",
        ),
    },
    {
        "label": "well_paths",
        "filename": os.path.join(
            script_working_dir, "data", "postgresql", "sql", "bsee.well_paths.sql"
        ),
    },
    {
        ...
        "filename": os.path.join(
            ...
            "postgresql",
            "sql",
            "bsee.well_monthly_production.sql",
        ),
    },
]
...
class GoMFieldsComponents:
    ...
    def get_gom_field_list_from_db(self):
        ...
        filename = os.path.join(
            script_working_dir,
            "data",
            self.dbe.server_type,
            "sql",
            "bsee.get_gom_fields.sql",
        )
        try:
    ...
    def get_data_from_db(self, gom_block):
        ...
        for cfg_data in data_from_db:
            df = self.dbe.executeScriptsFromFile(
                cfg_data["filename"], arg_array=[gom_block]
            )
