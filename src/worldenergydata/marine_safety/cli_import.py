...
def import_emsa(file: Optional[Path], info: bool, limit: Optional[int], verbose: bool):
    ...
    if info or file is None:
        from worldenergydata.marine_safety.importers.emsa_importer import (
            EMSAImporter,
        )
...
def import_noaa(
    ...
    try:
        ...
        from worldenergydata.marine_safety.importers.noaa_importer import (
            NOAAImporter,
        )
...
def import_boating(
    ...
    try:
        ...
        from worldenergydata.marine_safety.importers.boating_importer import (
            BoatingImporter,
        )
