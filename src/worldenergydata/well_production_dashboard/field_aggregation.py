...
from worldenergydata.bsee.reports.comprehensive.aggregators.field_aggregator_enhanced import (
    FieldAggregator as BSEEAggregator,
)
from worldenergydata.bsee.reports.comprehensive.models import Field, Lease, Well
...
try:
    from worldenergydata.bsee.reports.comprehensive.visualizations import (
        EconomicChart,
        ProductionChart,
    )
except ImportError:
