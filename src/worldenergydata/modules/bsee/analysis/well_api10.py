...
class WellAPI10:
    ...
    def router(self, cfg, well_group_api12_summary_df):
        ...
        cfg, well_group_api10_summary_df = self.field_analysis(
            cfg, well_group_api10_summary_df
        )
    ...
    def field_analysis(self, cfg, well_group_api10_summary_df):
        ...
        if len(well_group_api10_summary_df) > 1:
            for idx in range(0, len(well_group_api10_summary_df)):
                ...
                side_track_by_pass = well_group_api10_summary_df.loc[
                    idx, "Sidetrack and Bypass"
                ]
                try:
                    well_group_api10_summary_df.loc[idx, "WELL_LABEL"] = (
                        well_name + "_" + side_track_by_pass
                    )
