    ...
    def add_verification_error(
        ...
        **kwargs,
        ...
        error = VerificationError(
            field=field, message=message, severity=severity, well_id=well_id, **kwargs
        )
        ...
        self.add_audit_entry(
            ...
            details={"field": field, "message": message, "well_id": well_id},
        )
...
class VerificationWorkflow(DataValidator):
    ...
    def __init__(
        ...
        super().__init__(
            schema or ValidationSchema(name="verification", fields={}), strict
        )
    ...
    def start_verification(
        self, data_source: str, user: str, verification_id: Optional[str] = None
    ) -> VerificationResult:
        """
        ...
        logger.info(
            f"Started verification workflow: {self.current_result.verification_id}"
        )
    ...
    def save_checkpoint(self) -> Path:
        ...
        checkpoint_file = (
            self.checkpoint_dir
            / f"{self.current_result.verification_id}_checkpoint.json"
        )
    ...
    def resume_from_checkpoint(self, checkpoint_path: Path) -> None:
        ...
        self.current_result.add_audit_entry(
            action="verification_resumed", details={"checkpoint": str(checkpoint_path)}
        )
