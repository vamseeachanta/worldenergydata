...
class VerificationConfig:
    ...
    validation_rules: Dict[str, Any] = field(default_factory=lambda: {
        ...
        'quality': {
            ...
            'completeness': {
                'required_fields': [
                    'WELL_ID', 'LEASE_NUM', 'PRODUCTION_DATE',
                    'OIL_VOLUME', 'GAS_VOLUME'
                ],
                'optional_fields': [
                    'WATER_VOLUME', 'DAYS_ON_PRODUCTION'
                ]
            }
        },
        'thresholds': {
    ...
    def get_required_fields(self) -> List[str]:
        ...
        """
        return self.validation_rules.get('quality', {}).get('completeness', {}).get('required_fields', [])
    ...
    def get_anomaly_threshold(self) -> float:
        ...
        """
        return self.validation_rules.get('quality', {}).get('anomaly_detection', {}).get('threshold', 3.0)
    ...
    def get_production_limits(self, product_type: str) -> Dict[str, Any]:
        ...
        """
        return self.validation_rules.get('rules', {}).get('production_volume', {}).get(product_type, {})
