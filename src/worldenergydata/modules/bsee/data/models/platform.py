"""Dataclass model for BSEE platform structure records.

Provides domain logic (computed properties) on top of validated data
from PlatformStructureSchema.
"""
...
class PlatformStructure:
    """Domain model for a BSEE platform structure.

    Attributes use snake_case following Python conventions. Instantiate
    from a validated ``PlatformStructureSchema`` or directly with
    keyword arguments.
    """
    ...
    def is_active(self) -> bool:
        """Platform is active when it has not been removed."""
