...
from worldenergydata.modules.bsee.data._legacy.prepare_data_for_analysis import (
    PrepareBseeData,
)
...
from worldenergydata.modules.bsee.zip_data_dwnld.dwnld_from_zipurl import (
    DownloadFromZipUrl,
)
