...
Please use worldenergydata.modules.bsee.data.loaders.block.local_files instead.
"""
import warnings

warnings.warn(
    "Importing from 'worldenergydata.modules.bsee.data._by_block.data_from_local_files' is deprecated. "
    "Please use 'worldenergydata.modules.bsee.data.loaders.block.local_files' instead. "
