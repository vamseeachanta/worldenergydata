...
class GeographicChart:
    ...
    def create_well_location_map(self, wells: List[WellLocation],
                                boundaries: Optional[List[FieldBoundary]] = None,
                                title: str = None,
                                center_lat: Optional[float] = None,
                                center_lon: Optional[float] = None) -> go.Figure:
        """
        ...
        for status in set(w.status for w in wells):
            ...
            for well in status_wells:
                hover_text = f'<b>{well.well_name}</b><br>' + \
    ...
    def create_production_density_map(self, data: pd.DataFrame,
    ...
    def create_field_comparison_map(self, fields: Dict[str, List[WellLocation]],
    ...
    def create_3d_subsurface_view(self, wells: List[Dict[str, Any]],
                                 title: str = None) -> go.Figure:
        """
    ...
    def create_trajectory_comparison(self, wells: List[Dict[str, Any]],
                                   title: str = None) -> go.Figure:
        """
    ...
    def create_field_infrastructure_map(self, infrastructure: Dict[str, Any],
                                      title: str = None) -> go.Figure:
        """
