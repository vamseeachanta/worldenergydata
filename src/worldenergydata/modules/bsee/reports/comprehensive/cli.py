...
Examples:
  ...
  %(prog)s --type block --id 525 --progress --verbose
        ...
        parser.add_argument(
            '--ids',
            type=str,
            help='Multiple entity identifiers (comma-separated)'
        )
        ...
        parser.add_argument(
            '--data-path',
            type=str,
            help='Path to BSEE data directory'
        )
    ...
    def generate_single_report(self, report_type: str, 
                             entity_id: str,
                             output_format: str,
                             output_path: Path,
    ...
    def generate_batch_reports(self, report_type: str,
                             entity_ids: List[str],
                             output_format: str,
                             output_path: Path,
        ...
        logger.info(f"Batch generation complete: {len(report_paths)}/{total} successful")
        return report_paths
    
    def export_to_json(self, report: Dict[str, Any], 
                      output_path: Path, 
                      entity_id: str) -> Path:
        """
    ...
    def export_to_html(self, report: Dict[str, Any],
                      output_path: Path,
                      entity_id: str) -> Path:
        """
    ...
    def export_to_pdf(self, report: Dict[str, Any],
                     output_path: Path,
                     entity_id: str) -> Path:
        """
