...
class BatchExporter:
    ...
    def export_batch(self, data: Dict[str, Any], configs: List[ExportConfig]) -> List[ExportResult]:
        """
    ...
    def _export_single(self, data: Dict[str, Any], config: ExportConfig) -> ExportResult:
        """
    ...
    def export_all_formats(self, data: Dict[str, Any], base_path: Path, 
                          base_name: str = None) -> Dict[ExportFormat, ExportResult]:
        """
    ...
    def validate_configs(self, configs: List[ExportConfig]) -> List[str]:
        ...
        for i, config in enumerate(configs):
            ...
            if config.format not in self.exporters:
                errors.append(
                    f"Config {i}: Format {config.format.value} not supported"
                )
