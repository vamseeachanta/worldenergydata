...
class TemplateLoader:
    ...
    def load_template(self, template_name: str, template_type: Optional[str] = None) -> Optional[Template]:
        """
    ...
    def create_template_from_string(self, template_string: str, name: Optional[str] = None) -> Template:
        """
    ...
    def validate_template(self, template_name: str) -> Dict[str, Any]:
        ...
        if config:
            ...
            results['warnings'].append(f"Configuration file not found for '{template_name}'")
