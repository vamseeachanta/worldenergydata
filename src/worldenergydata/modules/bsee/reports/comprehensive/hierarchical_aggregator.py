...
from .models import (
    ...
    WellSummary, ProductionMetrics, EconomicMetrics
)
...
class BaseAggregator:
    ...
    def __init__(self, price_deck: Optional[PriceDeck] = None,
    ...
    def calculate_revenue(self, production: Dict[str, float]) -> Dict[str, float]:
        ...
        """
        oil_revenue = self.price_deck.get_oil_revenue(
            production.get('oil_bbls', 0)
        )
        gas_revenue = self.price_deck.get_gas_revenue(
            production.get('gas_mcf', 0)
        )
        ngl_revenue = self.price_deck.get_ngl_revenue(
            production.get('ngl_bbls', 0)
        )
    ...
    def calculate_costs(self, production: Dict[str, float],
                       revenue: Dict[str, float]) -> Dict[str, float]:
        """
        ...
        royalties = self.cost_structure.get_royalties(
...
class LeaseAggregator(BaseAggregator):
    ...
    def __init__(self, well_aggregator: Optional[WellAggregator] = None,
                 **kwargs):
        """
...
class FieldAggregator(BaseAggregator):
    ...
    def __init__(self, lease_aggregator: Optional[LeaseAggregator] = None,
                 **kwargs):
        """
...
class BlockAggregator(BaseAggregator):
    ...
    def __init__(self, field_aggregator: Optional[FieldAggregator] = None,
                 **kwargs):
        """
...
class HierarchicalAggregator:
    ...
    def aggregate_hierarchy(self, hierarchy: Dict[str, Any],
                          level: str = 'block') -> Dict[str, Any]:
        """
    ...
    def generate_report_data(self, block_number: Optional[str] = None,
    ...
    def _generate_summary(self, aggregated_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'profit_margin': (total_net_income / total_revenue * 100) if total_revenue > 0 else 0
        }
