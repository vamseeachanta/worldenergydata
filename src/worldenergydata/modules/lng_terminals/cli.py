...
Usage:
    uv run python -m worldenergydata.modules.lng_terminals.cli collect
    uv run python -m worldenergydata.modules.lng_terminals.cli collect --refresh-mode full
    uv run python -m worldenergydata.modules.lng_terminals.cli process
    uv run python -m worldenergydata.modules.lng_terminals.cli export
    uv run python -m worldenergydata.modules.lng_terminals.cli report
    uv run python -m worldenergydata.modules.lng_terminals.cli pipeline
"""
