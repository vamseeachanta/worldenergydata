...
from worldenergydata.modules.mexico_cnh.data.loaders.excel_loader import (
    COLUMN_MAPPING,
    CNHExcelLoader,
)
...
try:
    from worldenergydata.modules.mexico_cnh.data.loaders.pdf_parser import CNHPDFParser
