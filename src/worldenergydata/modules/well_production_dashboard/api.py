...
class DashboardAPI:
    ...
    def __init__(self, dashboard: Optional[WellProductionDashboard] = None, port: int = 5000):
        """
        Initialize API.
    ...
    def _register_routes(self):
        ...
        def get_decline_curve(well_id):
            ...
            if not decline:
                return jsonify({'error': f'No decline analysis for well {well_id}'}), 404
        ...
        def get_fields():
            """Get list of fields."""
            if self.dashboard.well_data is None or 'field' not in self.dashboard.well_data:
        ...
        def apply_filters():
            ...
            return jsonify({
                ...
                'data': filtered_data.head(100).to_dict('records')  # Return first 100 rows
            })
        ...
        def get_audit_trail(well_id):
            ...
            return jsonify({
                'well_id': well_id,
                'audit_trail': trail.to_dict('records')
            })
