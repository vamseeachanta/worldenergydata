...
class ExcelReportGenerator:
    ...
    def create_project_summary_sheet(self,
                                     project_name: str,
                                     financial_metrics: Dict[str, float],
                                     development_info: Dict[str, Any]) -> None:
        """
    ...
    def create_cashflow_detail_sheet(self,
                                     cashflow_df: pd.DataFrame,
                                     sheet_name: str = 'Monthly Cashflow') -> None:
        """
        ...
        for row_idx, row_data in enumerate(cashflow_df.values, start=start_row + 1):
            for col_idx, value in enumerate(row_data, start=1):
                ...
                if 'usd' in col_name.lower() or 'capex' in col_name.lower() or 'opex' in col_name.lower():
    ...
    def create_capex_summary_sheet(self,
                                   capex_breakdown: Dict[str, float],
                                   sheet_name: str = 'CAPEX Summary') -> None:
        """
    ...
    def create_production_summary_sheet(self,
                                       production_df: pd.DataFrame,
                                       sheet_name: str = 'Production Summary') -> None:
        """
...
def create_project_summary_sheet(workbook: Workbook,
                                 project_name: str,
...
class FDASReportBuilder:
    ...
    def build_complete_report(self,
                             ...
                             capex_breakdown: Optional[Dict[str, float]] = None) -> None:
        """
