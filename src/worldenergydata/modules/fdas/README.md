...
from worldenergydata.modules.fdas import classify_dev_system_by_depth
...
### 4. Drilling Timeline (`data/drilling.py`)

Extract drilling and completion schedules:
...
# - completion_monthly: Dict[str, int] (completions by month)
# - first_spud: datetime
...
# Run with coverage
python -m pytest tests/modules/fdas/ --cov=worldenergydata.modules.fdas
```
...
# Run with coverage
pytest tests/modules/fdas/ --cov=worldenergydata.modules.fdas --cov-report=html
```
