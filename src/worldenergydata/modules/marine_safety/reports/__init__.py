# ABOUTME: Reports package for marine safety module containing data quality dashboards and reporting utilities
...
from worldenergydata.modules.marine_safety.reports.quality_dashboard import (
    CompletenessReport,
    CoverageReport,
