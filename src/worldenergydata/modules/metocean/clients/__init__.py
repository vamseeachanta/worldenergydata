...
from worldenergydata.modules.metocean.clients.coops_client import (
    COOPSClient,
    COOPSCurrent,
    COOPSStation,
    COOPSTidePrediction,
...
from worldenergydata.modules.metocean.clients.erddap_client import (
    ERDDAPClient,
    ERDDAPDataset,
    ERDDAPObservation,
)
from worldenergydata.modules.metocean.clients.met_norway_client import (
    MetNorwayClient,
    MetNorwayForecast,
)
from worldenergydata.modules.metocean.clients.ndbc_client import (
    NDBCClient,
    NDBCObservation,
    NDBCStation,
)
from worldenergydata.modules.metocean.clients.open_meteo_client import (
    OpenMeteoClient,
    OpenMeteoForecast,
)
