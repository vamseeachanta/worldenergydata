...
from test_documentation_quality import (
...
class ComprehensiveQualitySystem:
    ...
    def __init__(self, project_root: Path):
        ...
        self.outdated_patterns = [
            ...
            (
                r"coming soon|under development|planned",
                "Check if feature is now available",
            ),
    ...
    def run_comprehensive_quality_analysis(self) -> Dict:
        ...
        results["formatting_fixes_needed"] = formatting_results[
        ...
        results["content_improvements_needed"] = clarity_results[
        ...
        results["outdated_content_found"] = outdated_results[
            "files_with_outdated_content"
        ]
    ...
    def _analyze_content_clarity(self) -> Dict:
            ...
            try:
                ...
                for indicator in technical_indicators:
                    if (
                        ...
                        and "energy professional" not in content.lower()
                    ):
        ...
        if clarity_issues:
            ...
            for issue in clarity_issues[:3]:
                print(
                    f"    - {issue['file']}: {len(issue['issues'])} improvements suggested"
                )
    ...
    def _analyze_metadata_completeness(self) -> Dict:
        ...
        for md_file in md_files:
            try:
                ...
                if (
                    "last updated" not in content.lower()
                    and "updated:" not in content.lower()
                ):
    ...
    def apply_quality_improvements(
        self, analysis_results: Dict, dry_run: bool = True
    ) -> Dict:
        ...
        improvement_results["improvements_applied"] += formatting_results[
            "fixes_applied"
        ]
        ...
        print(f"\nImprovement summary:")
        print(
            f"  Total improvements applied: {improvement_results['improvements_applied']}"
        )
...
def main():
    ...
    print(
        f"Files need clarity improvements: {analysis_results['content_improvements_needed']}"
    )
    ...
    dry_run_results = quality_system.apply_quality_improvements(
        analysis_results, dry_run=True
    )
    ...
    print(
        f"[SUCCESS] Dry run completed - ready to apply {dry_run_results['improvements_applied']} improvements"
    )

    # Apply actual improvements
    print("\nStep 2: Applying improvements...")
    improvement_results = quality_system.apply_quality_improvements(
        analysis_results, dry_run=False
    )
