...
This is the API specification for the spec detailed in @specs/trunk-based-development-workflow/spec.md
...
```json
{
  ...
  "is_spec_branch": true,
  "spec_folder": ".agent-os/specs/trunk-based-development-workflow",
