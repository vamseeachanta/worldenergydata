...
- Tasks: @specs/trunk-based-development-workflow/tasks.md
- Technical Specification: @specs/trunk-based-development-workflow/sub-specs/technical-spec.md
- API Specification: @specs/trunk-based-development-workflow/sub-specs/api-spec.md
- Tests Specification: @specs/trunk-based-development-workflow/sub-specs/tests.md