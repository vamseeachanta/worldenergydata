...
- Tasks: @specs/modules/infrastructure/trunk-based-development-workflow/tasks.md
- Technical Specification: @specs/modules/infrastructure/trunk-based-development-workflow/sub-specs/technical-spec.md
- API Specification: @specs/modules/infrastructure/trunk-based-development-workflow/sub-specs/api-spec.md
- Tests Specification: @specs/modules/infrastructure/trunk-based-development-workflow/sub-specs/tests.md