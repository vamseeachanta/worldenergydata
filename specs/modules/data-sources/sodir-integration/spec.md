...
- Tasks: @specs/sodir-integration/tasks.md
- Technical Specification: @specs/sodir-integration/sub-specs/technical-spec.md
- API Specification: @specs/sodir-integration/sub-specs/api-spec.md
- Database Schema: @specs/sodir-integration/sub-specs/database-schema.md
- Tests Specification: @specs/sodir-integration/sub-specs/tests.md