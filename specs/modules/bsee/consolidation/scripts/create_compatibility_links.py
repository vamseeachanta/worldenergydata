...
class CompatibilityLinker:
    ...
    def create_symlink(self, target: Path, link: Path):
        ...
        try:
            ...
            self.links_created.append({"link": str(link), "target": str(target)})
    ...
    def create_compatibility_links(self):
        ...
        compatibility_map = [
            ...
            {"old": "analysis_data/combined_data_for_analysis", "new": "current"},
            ...
            {"old": "legacy/data_for_analysis", "new": "current"},
        ]
    ...
    def save_link_registry(self):
        ...
        registry_file = Path(
            "specs/modules/bsee/consolidation/compatibility_links.json"
        )
    ...
    def generate_update_script(self):
        ...
        script_file = Path(
            "specs/modules/bsee/consolidation/scripts/update_code_references.py"
        )
