...
- Tasks: @specs/directional-surveys-fix/tasks.md
- Technical Specification: @specs/directional-surveys-fix/sub-specs/technical-spec.md
- Tests Specification: @specs/directional-surveys-fix/sub-specs/tests.md