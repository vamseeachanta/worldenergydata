...
- Tasks: @specs/decline-curve-analysis/tasks.md
- Technical Specification: @specs/decline-curve-analysis/sub-specs/technical-spec.md
- Tests Specification: @specs/decline-curve-analysis/sub-specs/tests.md