...
- Tasks: @specs/drilling-completion-script-validation/tasks.md
- Technical Specification: @specs/drilling-completion-script-validation/sub-specs/technical-spec.md
- Tests Specification: @specs/drilling-completion-script-validation/sub-specs/tests.md