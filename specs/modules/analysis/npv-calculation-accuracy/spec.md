...
- Tasks: @specs/npv-calculation-accuracy/tasks.md
- Technical Specification: @specs/npv-calculation-accuracy/sub-specs/technical-spec.md
- Tests Specification: @specs/npv-calculation-accuracy/sub-specs/tests.md