...
- Tasks: @specs/drilling-completion-output-validation/tasks.md
- Technical Specification: @specs/drilling-completion-output-validation/sub-specs/technical-spec.md
- Tests Specification: @specs/drilling-completion-output-validation/sub-specs/tests.md