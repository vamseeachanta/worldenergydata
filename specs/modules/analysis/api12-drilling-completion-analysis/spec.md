...
- Tasks: @specs/api12-drilling-completion-analysis/tasks.md
- Technical Specification: @specs/api12-drilling-completion-analysis/sub-specs/technical-spec.md
- Tests Specification: @specs/api12-drilling-completion-analysis/sub-specs/tests.md