...
5. **Spec Verification**: ALWAYS verify enhanced spec modular system compliance:
   - ✅ prompt.md exists with complete history
   - ✅ task_summary.md created for execution tracking
   - ✅ spec.md follows mandatory structure
   - ✅ tasks.md includes estimates and subtasks
...
- **MANDATORY**: Update task_summary.md continuously throughout task execution until all tasks in tasks.md are completed
...
- make an important note that uv tool and repo uv environment should be used for all work so that the repo uv envionment is always up to date for executing work
...
- make it mandatory for AI agents to not have Sycophancy. when unclear ask questions and clarifications
- **MANDATORY**: When AI proposes a different approach than user's suggestion, MUST get explicit user approval before proceeding
