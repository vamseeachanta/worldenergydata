...
On public BSEE production + cost data, **Jack St Malo** is **NPV-negative at 10%** life-to-date: terminal cumulative NPV **$-945.0 M** (sanctioned V30 model).

- **22 producing wells** (**73 total wellbores**), generating **$25,655 M** gross revenue.
- A **high-capex, deepwater** signature: **$12,850 M** of one-time D&C + facilities capital is the dominant driver of the NPV.
- The cumulative-NPV path bottomed at **$-3,154.7 M** in **2014** and has since recovered **$+2,209.7 M** as production paid back capital.
...
Cumulative discounted NPV evolution over field life, with critical well operations annotated. Terminal cumulative NPV = **$-945.0 M** (reconciles to sanctioned baseline $-945.0 M).

Cumulative NPV path (by year): `█▇▇▇▇▇▇▇▆▆▆▆▆▅▁▁▁▁▂▃▃▄▄▅▅▆`  _start $-75M → trough $-3,155M (2014) → latest $-945M_
...
| 2025 | 688.3 | -945.0 | Completion: PS012 (608124015504) |
...
Field terminal NPV decomposed into per-well contributions that sum exactly to the field total. Field NPV = **$-945.0 M**; sum of per-well net NPV = **$-945.0 M** (residual $0.0000).

| Rank | Well (API) | Name | Oil (MMbbl) | Gross well NPV ($MM) | Allocated shared cost ($MM) | Net well NPV ($MM) | % of field NPV |
|-----:|-----------|------|------------:|---------------------:|----------------------------:|-------------------:|-----------:|
| 1 | 608124005600 | PS003 | 22.87 | 78.2 | -178.5 | -100.3 | 10.6% |
| 2 | 608124005000 | PS005 | 23.46 | 93.3 | -183.2 | -89.9 | 9.5% |
| 3 | 608124005700 | PS001 | 32.45 | 189.3 | -253.3 | -64.0 | 6.8% |
| 4 | 608124005103 | PS004 | 37.06 | 231.5 | -289.4 | -57.9 | 6.1% |
| 5 | 608124005800 | PS004 | 37.11 | 234.2 | -289.7 | -55.5 | 5.9% |
| 6 | 608124005300 | PN001 | 18.68 | 94.2 | -145.9 | -51.6 | 5.5% |
| 7 | 608124011504 | PS007 | 23.64 | 133.6 | -184.5 | -50.9 | 5.4% |
| 8 | 608124005400 | PN002 | 29.95 | 184.3 | -233.8 | -49.6 | 5.2% |
| 9 | 608124011400 | PS002 | 34.77 | 223.0 | -271.5 | -48.5 | 5.1% |
| 10 | 608124011801 | PS005 | 15.89 | 81.9 | -124.1 | -42.2 | 4.5% |
| 11 | 608124010701 | PN007 | 29.34 | 189.0 | -229.1 | -40.1 | 4.2% |
| 12 | 608124012200 | PS007 | 17.65 | 97.8 | -137.8 | -40.0 | 4.2% |
| 13 | 608124012500 | PS006 | 9.25 | 33.0 | -72.2 | -39.2 | 4.2% |
| 14 | 608124001701 | PS002 | 25.27 | 161.6 | -197.3 | -35.7 | 3.8% |
| 15 | 608124012601 | PS003 | 1.98 | -15.8 | -15.5 | -31.3 | 3.3% |
| 16 | 608124011606 | PS008 | 13.19 | 71.8 | -103.0 | -31.1 | 3.3% |
| 17 | 608124013202 | PN005 | 7.86 | 32.9 | -61.4 | -28.5 | 3.0% |
| 18 | 608124012804 | PS009 | 8.93 | 49.9 | -69.7 | -19.7 | 2.1% |
| 19 | 608124015100 | PS008 | 4.62 | 18.7 | -36.1 | -17.3 | 1.8% |
| 20 | 608124014600 | PS011 | 3.25 | 8.1 | -25.4 | -17.3 | 1.8% |
| 21 | 608124013600 | PS006 | 8.30 | 47.5 | -64.8 | -17.3 | 1.8% |
| 22 | 608124005203 | PS001 | 1.14 | -8.1 | -8.9 | -17.0 | 1.8% |
...
NPV is linear in the oil price deck: each **+$1/bbl** on the realized oil price moves field NPV by **$+50.1 M**. Life-to-date NPV reaches **zero at a flat-equivalent realized WTI of $82/bbl**, versus the actual volume-weighted realized **$63/bbl** over the window.
