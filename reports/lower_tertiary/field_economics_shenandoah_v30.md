...
| 2025 | -1,167.1 | -1,166.4 | Well online (first production): API 608124014400 |
...
Field terminal NPV decomposed into per-well contributions that sum exactly to the field total. Field NPV = **$-1,166.4 M**; sum of per-well net NPV = **$-1,166.4 M** (residual $0.0000).
