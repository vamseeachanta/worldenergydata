...
On public BSEE production + cost data, **Big Foot** is **NPV-negative at 10%** life-to-date: terminal cumulative NPV **$-1,063.4 M** (sanctioned V30 model).

- **7 producing wells** (**38 total wellbores**), generating **$4,738 M** gross revenue.
- A **high-capex, deepwater** signature: **$4,517 M** of one-time D&C + facilities capital is the dominant driver of the NPV.
- The cumulative-NPV path bottomed at **$-1,484.3 M** in **2018** and has since recovered **$+420.9 M** as production paid back capital.
...
Cumulative NPV path (by year): `█▇▇▇▇▇▇▅▅▅▅▅▃▁▁▁▁▂▂▂▃`  _start $-92M → trough $-1,484M (2018) → latest $-1,063M_
...
NPV is linear in the oil price deck: each **+$1/bbl** on the realized oil price moves field NPV by **$+10.7 M**. Life-to-date NPV reaches **zero at a flat-equivalent realized WTI of $170/bbl**, versus the actual volume-weighted realized **$71/bbl** over the window.
