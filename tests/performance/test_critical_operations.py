...
class TestCriticalOperationsPerformance:
    ...
    def test_data_loading_performance(self, benchmark, sample_production_data, tmp_path):
    ...
    def test_directional_survey_calculation_performance(self, benchmark, sample_well_data):
...
class TestParallelPerformance:
    ...
    def test_parallel_data_processing(self, benchmark, sample_production_data):
        ...
        def process_well_data(well_id):
            ...
            well_data['ma_7'] = well_data['oil_production'].rolling(
