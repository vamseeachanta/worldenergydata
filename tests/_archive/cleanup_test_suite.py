...
class TestSuiteCleanup:
    ...
    def analyze_test_file(self, filepath: Path) -> Dict:
        ...
        try:
            ...
            if any(
                ...
                for keyword in ["helper", "util", "base", "conftest", "fixture"]
            ):
                    ...
                    for node in ast.walk(tree):
                        if isinstance(node, ast.ImportFrom):
                            if node.module and "worldenergydata" in node.module:
                                ...
                                if (
                                    "memory_processor" in module_path
                                    or "cache_manager" in module_path
                                ):
        ...
        for root, dirs, files in os.walk(self.test_dir):
            ...
            for file in files:
                ...
                if analysis["is_helper"]:
                    ...
                    "ai_test_generation" in str(filepath)
                    and analysis["test_count"] == 0
                ):
                    remove.append(
                        filepath
                    )  # Remove AI test infrastructure with no tests
    ...
    def generate_report(self) -> str:
        ...
        if self.report["errors"]:
            report_lines.extend(["## Errors During Cleanup", ""])
