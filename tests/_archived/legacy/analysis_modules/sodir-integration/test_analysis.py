...
class TestCrossRegionalAnalysis:
    ...
    def test_data_normalization(self, cross_regional_analyzer, sample_sodir_data, sample_bsee_data):
    ...
    def test_metric_comparison(self, cross_regional_analyzer, sample_sodir_data, sample_bsee_data):
    ...
    def test_field_matching(self, cross_regional_analyzer):
        ...
        matches = cross_regional_analyzer.find_comparable_fields(
            sodir_fields,
            bsee_fields,
            criteria=['size_class', 'water_depth_range']
        )
...
class TestNorwayNPVCalculations:
    ...
    def test_norwegian_tax_calculation(self, financial_params):
        ...
        expected_petroleum = (taxable_income - expected_corporate) * 0.56  # Using special_tax_rate
    ...
    def test_npv_calculation(self, financial_params, production_profile):
        ...
        result = calculator.calculate_npv(
            production_profile,
            capex_schedule=financial_params.capex_schedule
        )
...
class TestVisualization:
    ...
    def test_comparison_dashboard(self, visualizer, sample_sodir_data, sample_bsee_data):
...
class TestProductionForecasting:
    ...
    def test_decline_curve_fitting(self, forecaster, historical_production):
        ...
        decline_params = forecaster.fit_decline_curve(
            historical_production['oil_production'],
    ...
    def test_forecast_validation(self, forecaster, historical_production):
        ...
        validation = forecaster.validate_forecast(
            ...
            test_data[['oil_production', 'gas_production']]
        )
    ...
    def test_scenario_forecasting(self, forecaster, historical_production):
        ...
        assert (scenario_forecasts['optimistic'].forecast_values > 
                scenario_forecasts['pessimistic'].forecast_values).all()