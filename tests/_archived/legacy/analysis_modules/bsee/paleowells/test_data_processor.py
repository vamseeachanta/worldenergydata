...
from worldenergydata.modules.bsee.paleowells.data_processor import PaleowellsDataProcessor
...
class TestPaleowellsDataProcessor:
    ...
    def test_filter_epochs(self, processor, temp_dir, sample_paleo_data):
        ...
        assert records == 3  # Should find Oligocene, Eocene, and Paleocene
    ...
    def test_parse_fixed_width_file_with_csv_output(self, processor, temp_dir, sample_paleo_data):
    ...
    def test_analyze_well_epochs(self, processor, temp_dir):
        ...
        data = {
            'API Well Number': ['608054000300', '608054000300', '608054000301', '608054000301'],
            'Paleo Age': [
    ...
    def test_process_paleowells_data_complete(self, processor, temp_dir, sample_paleo_data):
