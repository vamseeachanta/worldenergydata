...
class TestDrillingCompletionProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dc_monthly = pd.DataFrame({
            'YearMonth': pd.date_range('2023-01-01', periods=5, freq='MS').tolist() * 3,
    ...
    def test_calculate_drilling_costs(self):
        ...
        costs = self.processor.calculate_drilling_costs(
            self.dc_totals,
            self.cost_assumptions['DRILL_COST_PER_DAY']
        )
    ...
    def test_calculate_completion_costs(self):
        ...
        costs = self.processor.calculate_completion_costs(
            self.dc_totals,
            self.cost_assumptions['COMP_COST_PER_DAY']
        )
    ...
    def test_allocate_costs_monthly(self):
        ...
        jan_2023 = monthly_allocation[monthly_allocation['YearMonth'] == pd.Timestamp('2023-01-01')]
    ...
    def test_calculate_first_oil_impact(self):
        ...
        first_oil = self.processor.calculate_first_oil_dates(
            self.dc_totals,
            production
        )
