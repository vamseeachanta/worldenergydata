...
class TestBlockAggregator:
    ...
    def test_block_aggregator_initialization(self):
        ...
        from src.worldenergydata.modules.bsee.reports.comprehensive.aggregators.block_aggregator import BlockAggregator
...
class TestLeaseAggregator:
    ...
    def test_lease_aggregator_initialization(self):
        ...
        from src.worldenergydata.modules.bsee.reports.comprehensive.aggregators.lease_aggregator import LeaseAggregator
