...
from src.worldenergydata.modules.bsee.reports.comprehensive.templates.operational_template import (
    OperationalTemplate,
...
class TestFailureAnalysis(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.failure = FailureAnalysis(
            ...
            repair_cost=25000,
            preventable=True,
            corrective_actions=["Install sand screens", "Increase monitoring frequency"],
...
class TestOperationalTemplate(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.template = OperationalTemplate(
            template_name="test_operational",
            version="1.0.0"
        )
    ...
    def test_add_drilling_performance_analysis(self):
        ...
        context = {}
        self.template.add_drilling_performance_analysis(
            context,
            [self.well_metrics]
        )
    ...
    def test_add_equipment_utilization_analysis(self):
        ...
        context = {}
        self.template.add_equipment_utilization_analysis(
            context,
            [equipment]
        )
