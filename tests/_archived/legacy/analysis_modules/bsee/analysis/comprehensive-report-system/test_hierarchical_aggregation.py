...
class TestHierarchicalAggregation(unittest.TestCase):
    ...
    def test_well_aggregation(self):
        ...
        self.assertAlmostEqual(metrics['operating_cost'], expected_operating_cost, places=2)
        self.assertAlmostEqual(metrics['royalties'], expected_royalties, places=2)
        self.assertAlmostEqual(metrics['severance_tax'], expected_severance_tax, places=2)
    ...
    def test_hierarchical_aggregator_integration(self):
        ...
        hierarchy = {
            ...
            'leases': {
                'OCS-G-12345': self.lease1,
                'OCS-G-12346': self.lease2
            },
            'wells': {
                'API001': self.well1,
                'API002': self.well2,
