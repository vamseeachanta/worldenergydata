...
class TestCodeAnalysis:
    ...
    def test_analyze_script_imports(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import analyze_script_imports
    ...
    def test_analyze_function_definitions(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import analyze_function_definitions
    ...
    def test_analyze_data_sources(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import analyze_data_sources
    ...
    def test_analyze_date_calculations(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import analyze_date_calculations
    ...
    def test_analyze_drilling_completion_logic(self, lease_script_path, api12_script_path):
        """Test analysis of drilling and completion day calculation logic."""
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import analyze_drilling_completion_logic
    ...
    def test_compare_methodologies(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import compare_methodologies
    ...
    def test_extract_business_rules(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import extract_business_rules
    ...
    def test_analyze_script_complexity(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import analyze_script_complexity
    ...
    def test_identify_key_differences(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import identify_key_differences
    ...
    def test_generate_methodology_summary(self, lease_script_path, api12_script_path):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.code_analyzer import generate_methodology_summary
        ...
        print(f"Lease method functions: {len(summary['lease_method']['key_functions'])}")
        print(f"API12 method functions: {len(summary['api12_method']['key_functions'])}")
