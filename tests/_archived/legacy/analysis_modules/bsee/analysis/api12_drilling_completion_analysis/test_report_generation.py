...
class TestReportGeneration:
    ...
    def sample_methodology_data(self):
        ...
        return {
            ...
            'api12_method': {
                ...
                'data_sources': ['Well data structure', 'WellRigDays', 'Directional surveys']
            }
        }
    
    def test_generate_executive_summary(self, sample_comparison_data, sample_methodology_data):
        """Test generation of executive summary section."""
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import generate_executive_summary
        
        summary = generate_executive_summary(sample_comparison_data, sample_methodology_data)
    ...
    def test_analyze_calculation_differences(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import analyze_calculation_differences
        ...
        print(f"  Highest drilling difference: {extreme_cases['highest_drilling_diff']['diff']} days")
        print(f"  Lowest drilling difference: {extreme_cases['lowest_drilling_diff']['diff']} days")
        print(f"  Highest completion difference: {extreme_cases['highest_completion_diff']['diff']} days")
    
    def test_generate_field_by_field_analysis(self, sample_comparison_data):
        """Test generation of field-by-field analysis."""
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import generate_field_analysis
        ...
        for field_name, analysis in field_analysis.items():
            print(f"  {field_name}: {analysis['wells_count']} wells, "
                  f"avg drilling diff: {analysis['average_drilling_diff']:.1f} days")
    
    def test_identify_root_causes(self, sample_comparison_data, sample_methodology_data):
        """Test identification of root causes for calculation differences."""
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import identify_root_causes
        
        root_causes = identify_root_causes(sample_comparison_data, sample_methodology_data)
    ...
    def test_generate_statistical_analysis(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import generate_statistical_analysis
        ...
        for diff_type in ['drilling_differences', 'completion_differences', 'total_differences']:
    ...
    def test_create_comparison_tables(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import create_comparison_tables
        ...
        print(f"  Field summary table: {'created' if tables['field_summary_table'] else 'failed'}")
    
    def test_generate_recommendations(self, sample_comparison_data, sample_methodology_data):
        """Test generation of actionable recommendations."""
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import generate_recommendations
        
        recommendations = generate_recommendations(sample_comparison_data, sample_methodology_data)
    ...
    def test_compile_comprehensive_report(self, sample_comparison_data, sample_methodology_data):
        """Test compilation of comprehensive markdown report."""
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import compile_comprehensive_report
        
        report = compile_comprehensive_report(sample_comparison_data, sample_methodology_data)
    ...
    def test_save_report_to_file(self, sample_comparison_data, sample_methodology_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import save_report_to_file
        
        # Generate report
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import compile_comprehensive_report
        report_content = compile_comprehensive_report(sample_comparison_data, sample_methodology_data)
    ...
    def test_generate_methodology_comparison_table(self):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import generate_methodology_comparison_table
    ...
    def test_calculate_accuracy_metrics(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import calculate_accuracy_metrics
    ...
    def test_export_analysis_data(self, sample_comparison_data, sample_methodology_data):
        """Test export of analysis data to JSON format."""
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.report_generator import export_analysis_data
        
        output_path = "tests/modules/bsee/analysis/api12_drilling_completion_analysis/results/test_analysis_data.json"
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        
        success = export_analysis_data(sample_comparison_data, sample_methodology_data, output_path)
