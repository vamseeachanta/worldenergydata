...
class TestDashboardPerformance(unittest.TestCase):
    ...
    def test_dashboard_initial_load_time(self):
        ...
        try:
            from worldenergydata.modules.well_production_dashboard.well_production import WellProductionDashboard
            ...
            self.assertLess(load_time, 3.0, f"Dashboard load time {load_time:.2f}s exceeds 3s limit")
            ...
            self.assertLess(load_time, 3.0, f"Mock dashboard load time {load_time:.2f}s exceeds 3s limit")
    
    def test_chart_refresh_performance(self):
        """Test chart refresh completes within 500ms."""
        try:
            from worldenergydata.modules.well_production_dashboard.interactive_components import InteractiveComponents
        ...
        self.assertLess(avg_refresh_time, 0.5, 
                       f"Average chart refresh time {avg_refresh_time:.3f}s exceeds 500ms")
        self.assertLess(max_refresh_time, 0.75,
    ...
    def test_large_dataset_handling(self):
        ...
        result = {
            ...
            'avg_oil_per_well': large_data.groupby('well_id')['oil_production'].mean().mean(),
            'avg_gas_per_well': large_data.groupby('well_id')['gas_production'].mean().mean()
        }
    ...
    def test_export_performance(self):
        ...
        self.assertLess(excel_time, 10.0,
                       f"Excel export took {excel_time:.2f}s, exceeds 10s limit")
        self.assertLess(pdf_time, 10.0,
                       f"PDF export took {pdf_time:.2f}s, exceeds 10s limit")
    ...
    def test_api_response_time(self):
        ...
        self.assertLess(percentile_95, 300,
...
class TestDashboardScalability(unittest.TestCase):
    ...
    def test_well_count_scalability(self):
        ...
        for count in well_counts:
            ...
            result = {
                ...
                'well_stats': test_data.groupby('well_id')['oil_production'].agg(['mean', 'sum', 'std'])
            }
            processing_time = time.time() - start_time
        ...
        self.assertLess(time_ratio, data_ratio * 0.5,
    ...
    def test_query_optimization(self):
        ...
        self.assertGreater(improvement_factor, 5,
