...
class TestEndToEndWorkflow:
    ...
    def sample_production_data(self):
        ...
        data = {
            ...
            'DEV_NAME': ['Anchor'] * 12,
            'PROD_DATE': dates,
            'OIL_VOLUME': [10000, 15000, 20000, 25000, 25000, 24000,
                          23000, 22000, 21000, 20000, 19000, 18000],
            'WATER_VOLUME': [1000, 1500, 2000, 2500, 3000, 3500,
    ...
    def test_complete_analysis_workflow(self,
        ...
        # Mock WTI prices
        wti_prices = {
            f'2024-{i:02d}': 75.0 for i in range(1, 13)
        }
    ...
    def test_production_aggregation_pipeline(self, sample_production_data):
        ...
        # Monthly aggregation
        monthly = aggregate_monthly_production(
            sample_production_data,
            by='DEV_NAME'
        )
        ...
        assert summary['TOTAL_OIL_BBL'].iloc[0] == sample_production_data['OIL_VOLUME'].sum()
    ...
    def test_activity_classification(self):
        ...
        assert classifier.classify_activity("Perforated 15,000-15,500ft") == 'completion'
    ...
    def test_financial_metrics_calculation(self):
        ...
        cashflows = np.array([
            -1000,  # Initial CAPEX
            100, 200, 300, 400, 500,  # Growing production
            500, 450, 400, 350, 300,  # Declining production
        ])
...
class TestDataValidation:
    ...
    def test_missing_production_columns(self):
        ...
        from src.worldenergydata.modules.fdas.data.production import ProductionProcessingError
