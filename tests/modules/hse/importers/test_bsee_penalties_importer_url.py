...
from worldenergydata.modules.hse.importers.bsee_penalties_importer_url import (
...
class TestBSEEPenaltiesImporterURL:
    ...
    def test_fetch_data_downloads_from_war_url(
        ...
        with patch.object(
            ...
            mock_process.assert_called_once_with(
                mock_zip_data, cfg={"extract_year_month": True}
            )
    ...
    def test_fetch_data_uses_longest_timeout(
        self, db_session, mock_zip_data, mock_processed_data
    ):
    ...
    def test_normalize_data_converts_compliance_deadline_to_datetime(
        self, db_session, mock_zip_data, mock_processed_data
    ):
    ...
    def test_normalize_data_converts_compliance_achieved_to_boolean(
        self, db_session, mock_zip_data, mock_processed_data
    ):
    ...
    def test_normalize_data_sets_incident_type_violation(
        self, db_session, mock_zip_data, mock_processed_data
    ):
                ...
                [
                    {
                        ...
                        "compliance_deadline": "2024-09-15",
                        "compliance_achieved": "False",
                    }
                ]
            ),
