...
with patch('src.worldenergydata.modules.well_production_dashboard.api_enhanced.Flask'):
    with patch('src.worldenergydata.modules.well_production_dashboard.api_enhanced.jsonify'):
        from src.worldenergydata.modules.well_production_dashboard.api_enhanced import (
...
class TestWebSocketManager:
    ...
    async def test_real_time_data_push(self, websocket_manager):
        ...
        await websocket_manager.push_production_update(
            well_id='W001',
            data={'oil_rate': 1050, 'timestamp': datetime.now()}
        )
