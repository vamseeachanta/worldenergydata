...
from src.worldenergydata.modules.well_production_dashboard.well_production import (
...
from src.worldenergydata.modules.well_production_dashboard.monitoring import (
    DashboardMonitor,
    AuditEntry
)
...
"""
    ...
    def setUp(self):
        ...
        with patch('src.worldenergydata.modules.well_production_dashboard.well_production.DashboardBuilder'):
    ...
    def test_complete_workflow(self):
        ...
        aggregator.get_field_data = Mock(return_value={
            'Field1': {'wells': ['W001'], 'production': self.mock_data}
        })
    ...
    def test_quality_filtering_workflow(self):
        ...
        self.dashboard.get_well_data = Mock(side_effect=[
            data_high_quality,
            data_low_quality
        ])
...
class TestCLIIntegration(unittest.TestCase):
    ...
    @patch('src.worldenergydata.modules.well_production_dashboard.cli.WellProductionDashboard')
