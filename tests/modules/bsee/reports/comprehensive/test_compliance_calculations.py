...
class TestComplianceCalculations:
    ...
    def test_production_compliance_zero_permitted(self):
        ...
        metrics = ComplianceMetrics(
            permitted_production_bbls=0,
            actual_production_bbls=50000
        )
