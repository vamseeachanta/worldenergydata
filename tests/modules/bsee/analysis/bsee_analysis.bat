...
python -m energydata query_field_stones.yml
...
@REM python -m energydata query_field_stones.yml "{'meta': {'label': 'goa_julia_508'}, 'data': {'groups': [{'bottom_block': [508]}]}}"
@REM python -m energydata query_field_stones.yml "{'meta': {'label': 'goa_julia_464'}, 'data': {'groups': [{'bottom_block': [509]}]}}"
