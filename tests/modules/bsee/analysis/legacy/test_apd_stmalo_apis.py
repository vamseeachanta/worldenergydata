...
<<<<<<< HEAD:tests/modules/bsee/analysis/legacy_2025_02_21/test_apd_julia_by_block.py
    input_file = 'apd_julia_by_block.yml'
=======
    input_file = 'apd_stmalo_apis.yml'
>>>>>>> 202502:tests/modules/bsee/analysis/legacy/test_apd_stmalo_apis.py
