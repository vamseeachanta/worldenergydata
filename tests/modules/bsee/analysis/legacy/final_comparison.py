...
def main():
    ...
    print("📊 EXCEL ANALYSIS RESULTS (from NPV_JStM-WELL-Production-Data-thru-2019.xlsx):")
    ...
    if os.path.exists(results_file):
        ...
        if manual_rate == 0.10:  # Both using 10%
            ...
            print("⚠️  WARNING: Manual analysis using different discount rate than Excel")
