...
from src.worldenergydata.modules.bsee.analysis.financial.data_loader import (
    SMEDataLoader,
...
class TestSMEDataLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_drilling_df = pd.DataFrame({
            ...
            'DRILL_DAYS': [30, 45, 60],
            'COMP_DAYS': [15, 20, 25],
            'WELL_SPUD_DATE': pd.to_datetime(['2023-01-01', '2023-02-01', '2023-03-01']),
            'TOTAL_DEPTH_DATE': pd.to_datetime(['2023-01-31', '2023-03-17', '2023-05-01'])
        })
    ...
    def test_normalize_lease_number(self):
        ...
        self.assertEqual(normalize_lease_number(' g12345 '), 'G12345')
        self.assertEqual(normalize_lease_number('G-12345'), 'G-12345')  # Invalid format preserved
    ...
    @patch('src.worldenergydata.modules.bsee.analysis.financial.data_loader.HierarchicalDataLoader')
    def test_load_leases_data(self, mock_hierarchical):
        ...
        self.assertTrue(all(l.startswith('G') for l in leases['LEASE_NUM'] if pd.notna(l)))
    ...
    def test_integration_with_comprehensive_loader(self):
        ...
        with patch('src.worldenergydata.modules.bsee.reports.comprehensive.data_loader_enhanced.HierarchicalDataLoader') as mock_class:
            mock_instance = MagicMock()
...
class TestDataValidation(unittest.TestCase):
    ...
    def test_validate_required_columns(self):
        ...
        from src.worldenergydata.modules.bsee.analysis.financial.data_loader import validate_required_columns
    ...
    def test_validate_date_columns(self):
        ...
        from src.worldenergydata.modules.bsee.analysis.financial.data_loader import validate_date_columns
