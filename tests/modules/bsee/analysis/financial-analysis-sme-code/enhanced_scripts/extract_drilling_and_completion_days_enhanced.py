...
if not os.path.exists(lease_file):
    ...
    if not os.path.exists(lease_file):
        raise FileNotFoundError(f"Could not find leases.xlsx in current directory or SME directory")
...
if not os.path.exists(war_main_bin_file):
    ...
    war_main_bin_file = os.path.join(os.path.dirname(__file__), "../../../../../../data/modules/bsee/bin/war/mv_war_main.bin")
    if not os.path.exists(war_main_bin_file):
...
# ONLY CHANGE: Read from binary file instead of CSV
boreholes_bin_file = "../../../../../../data/modules/bsee/bin/war/mv_war_boreholes_view.bin"
if not os.path.exists(boreholes_bin_file):
    # Try alternative path from project root
    boreholes_bin_file = os.path.join(os.path.dirname(__file__), "../../../../../../data/modules/bsee/bin/war/mv_war_boreholes_view.bin")
    if not os.path.exists(boreholes_bin_file):
        raise FileNotFoundError(f"Could not find mv_war_boreholes_view.bin in expected locations")
...
if not os.path.exists(main_prop_bin_file):
    # Try alternative path from project root
    main_prop_bin_file = os.path.join(os.path.dirname(__file__), "../../../../../../data/modules/bsee/bin/war/mv_war_main_prop.bin")
    if not os.path.exists(main_prop_bin_file):
        raise FileNotFoundError(f"Could not find mv_war_main_prop.bin in expected locations")
...
# ONLY CHANGE: Read from binary file instead of CSV
remarks_bin_file = "../../../../../../data/modules/bsee/bin/war/mv_war_main_prop_remark.bin"
if not os.path.exists(remarks_bin_file):
    # Try alternative path from project root
    remarks_bin_file = os.path.join(os.path.dirname(__file__), "../../../../../../data/modules/bsee/bin/war/mv_war_main_prop_remark.bin")
    if not os.path.exists(remarks_bin_file):
        raise FileNotFoundError(f"Could not find mv_war_main_prop_remark.bin in expected locations")
