...
class TestDataValidator(unittest.TestCase):
    ...
    def test_validate_required_columns(self):
        ...
        result = validate_required_columns(
            self.valid_leases, ["LEASE_NUM", "LEASE_NAME", "DEV_NAME"]
        )
        ...
        with self.assertRaises(ValueError) as context:
            validate_required_columns(
                self.valid_leases, ["LEASE_NUM", "MISSING_COLUMN"]
            )
    ...
    def test_validate_date_columns(self):
        ...
        result = validate_date_columns(
            mixed_dates, ["DATE1", "DATE2", "DATE3", "DATE4"]
        )
    ...
    def test_validate_numeric_columns(self):
        ...
        result = validate_numeric_columns(
            mixed_numeric, ["NUM1", "NUM2", "NUM3", "NUM4"], fill_invalid=0
        )
        ...
        result_nan = validate_numeric_columns(
            mixed_numeric, ["NUM4"], fill_invalid=None
        )
    ...
    def test_validate_financial_assumptions(self):
        ...
        # Valid assumptions
        is_valid, errors = self.validator.validate_financial_assumptions(
            self.valid_assumptions
        )
        self.assertTrue(is_valid)
        self.assertEqual(len(errors), 0)
