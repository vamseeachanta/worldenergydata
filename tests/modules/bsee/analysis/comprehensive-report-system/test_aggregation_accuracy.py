...
from src.worldenergydata.modules.bsee.reports.comprehensive.models import (
    Well, Lease, Field, Block, ProductionMetrics
)
from src.worldenergydata.modules.bsee.reports.comprehensive.aggregators import (
    BlockAggregator, FieldAggregator, LeaseAggregator
)
from src.worldenergydata.modules.bsee.reports.comprehensive.data_loader import HierarchicalDataLoader
...
class TestAggregationAccuracy:
    ...
    def test_multilevel_aggregation_consistency(self):
        ...
        # Verify consistency
        assert lease1_result["oil_bbls"] + lease2_result["oil_bbls"] == field_result["oil_bbls"]
    ...
    def test_revenue_calculation_accuracy(self):
        ...
        expected_gross = expected_oil_revenue + expected_gas_revenue + expected_ngl_revenue
        ...
        expected_total_cost = expected_oil_cost + expected_water_cost + expected_gas_cost
    ...
    def test_large_number_aggregation(self):
        ...
        for lease_num in range(100):
            ...
            for well_num in range(10):
                well = Well(f"W{lease_num}_{well_num}", f"PS{lease_num:03d}{well_num:02d}", 
                          lease_id=lease.id)
                well.set_production_data({
    ...
    def test_date_range_filtering(self):
        ...
        well2 = Well("W2", "PS002", lease_id="L1",
                    spud_date=date(2021, 6, 20))
        well2.set_production_data({"oil_bbls": 30000, "gas_mcf": 15000})
        
        well3 = Well("W3", "PS003", lease_id="L1",
                    spud_date=date(2022, 3, 10))
...
class TestDataValidation:
    ...
    def test_negative_production_detection(self):
        ...
        from src.worldenergydata.modules.bsee.reports.comprehensive.aggregators.base import DataAggregator
    ...
    def test_data_completeness_check(self):
        ...
        from src.worldenergydata.modules.bsee.reports.comprehensive.aggregators.field_aggregator import FieldAggregator
