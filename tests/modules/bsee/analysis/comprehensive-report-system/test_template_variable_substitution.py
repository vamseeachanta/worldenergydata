...
class TestTemplateVariableSubstitution:
    ...
    def test_basic_variable_substitution(self):
        ...
        template = BaseReportTemplate(
            template_name="variable_test", template_type="economic"
        )
    ...
    def test_currency_filter(self):
        ...
        template = BaseReportTemplate(
            template_name="currency_test", template_type="economic"
        )
    ...
    def test_currency_filter_with_custom_symbol(self):
        ...
        template = BaseReportTemplate(
            template_name="currency_custom_test", template_type="economic"
        )
    ...
    def test_percentage_filter(self):
        ...
        template = BaseReportTemplate(
            template_name="percentage_test", template_type="economic"
        )
    ...
    def test_percentage_filter_with_decimals(self):
        ...
        template = BaseReportTemplate(
            template_name="percentage_decimals_test", template_type="economic"
        )
    ...
    def test_number_format_filter(self):
        ...
        template = BaseReportTemplate(
            template_name="number_test", template_type="economic"
        )
    ...
    def test_number_format_filter_with_decimals(self):
        ...
        template = BaseReportTemplate(
            template_name="number_decimals_test", template_type="economic"
        )
    ...
    def test_date_format_filter(self):
        ...
        template = BaseReportTemplate(
            template_name="date_test", template_type="economic"
        )
    ...
    def test_date_format_filter_custom_format(self):
        ...
        template = BaseReportTemplate(
            template_name="date_custom_test", template_type="economic"
        )
    ...
    def test_bbl_format_filter(self):
        ...
        template = BaseReportTemplate(
            template_name="bbl_test", template_type="economic"
        )
    ...
    def test_mcf_format_filter(self):
        ...
        template = BaseReportTemplate(
            template_name="mcf_test", template_type="economic"
        )
    ...
    def test_days_format_filter(self):
        ...
        template = BaseReportTemplate(
            template_name="days_test", template_type="operational"
        )
    ...
    def test_none_value_handling(self):
        ...
        template = BaseReportTemplate(
            template_name="none_test", template_type="economic"
        )
    ...
    def test_complex_nested_context(self):
        ...
        template = BaseReportTemplate(
            template_name="nested_test", template_type="economic"
        )
        ...
        context = {
            "field": {
                "name": "Jack Field",
                "production": {"oil_bbls": 125000, "gas_mcf": 200000},
                "economics": {"total_revenue": 10500000.50, "profit_margin": 34.567},
            }
        }
    ...
    def test_custom_jinja_functions(self):
        ...
        template = BaseReportTemplate(
            template_name="functions_test", template_type="economic"
        )
    ...
    def test_conditional_rendering(self):
        ...
        template = BaseReportTemplate(
            template_name="conditional_test", template_type="economic"
        )
        ...
        context = {
            "field": {"active": True, "production": 50000, "profit_margin": 25.5}
        }
    ...
    def test_loop_rendering(self):
        ...
        template = BaseReportTemplate(
            template_name="loop_test", template_type="economic"
        )
    ...
    def test_template_error_handling(self):
        ...
        template = BaseReportTemplate(
            template_name="error_test", template_type="economic"
        )
