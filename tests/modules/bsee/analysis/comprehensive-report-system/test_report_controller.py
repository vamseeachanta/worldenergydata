...
class TestReportController:
    ...
    def test_report_controller_with_config_file(self):
        ...
        config_data = {
            "data_source": {"type": "bsee", "connection": "test_connection"},
    ...
    def test_report_validation(self):
        ...
        config = ReportConfiguration(report_type=ReportType.FIELD, entity_name="Jack")
    ...
    def test_report_metadata_generation(self):
        ...
        config = ReportConfiguration(
            report_type=ReportType.BLOCK, entity_name="Walker Ridge 759"
        )
...
class TestHierarchyRelationships:
    ...
    def test_build_hierarchy_from_data(self):
        ...
        raw_data = {
            ...
            "fields": [{"id": "F1", "name": "Jack", "block_id": "B1"}],
            "blocks": [{"id": "B1", "number": "759", "area": "Walker Ridge"}],
        }
