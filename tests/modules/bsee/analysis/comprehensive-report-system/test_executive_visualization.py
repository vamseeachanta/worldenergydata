...
class TestExecutiveVisualization(unittest.TestCase):
    ...
    @patch(
        "worldenergydata.modules.bsee.reports.comprehensive.templates.executive_template.go"
    )
    ...
    @patch(
        "worldenergydata.modules.bsee.reports.comprehensive.templates.executive_template.make_subplots"
    )
    def test_multi_panel_dashboard_creation(self, mock_subplots):
        ...
        dashboard = self.template.create_multi_panel_dashboard(
            panels, self.dashboard_data
        )
...
class TestCompetitiveBenchmarking(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.benchmark_data = {
            ...
            "industry_benchmarks": {
                ...
                "safety_score": {"p25": 85.0, "p50": 90.0, "p75": 94.0, "p90": 97.0},
                "environmental_score": {
                    "p25": 80.0,
                    "p50": 87.0,
                    "p75": 92.0,
            ...
            "peer_companies": [
                {
                    "name": "Company A",
                    "production_efficiency": 90.2,
                    "safety_score": 93.5,
                },
                {
                    "name": "Company B",
                    "production_efficiency": 86.5,
                    "safety_score": 96.0,
                },
                {
                    "name": "Company C",
                    "production_efficiency": 91.8,
                    "safety_score": 92.0,
                },
            ],
        }
    ...
    def test_peer_ranking_table(self):
        ...
        self.assertEqual(
            len(ranking_table), len(self.benchmark_data["peer_companies"]) + 1
        )  # +1 for our company
