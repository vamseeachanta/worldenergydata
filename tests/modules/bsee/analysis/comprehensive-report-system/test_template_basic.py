...
from worldenergydata.modules.bsee.reports.comprehensive.templates.base import (
    BaseReportTemplate,
    TemplateContext,
)
...
class TestBaseReportTemplateBasic:
    ...
    def test_invalid_template_type(self):
        ...
        with pytest.raises(ValueError, match="Invalid template type"):
            BaseReportTemplate(template_name="test", template_type="invalid_type")
    ...
    def test_context_setting(self):
        ...
        template = BaseReportTemplate(
            template_name="context_test", template_type="economic"
        )
    ...
    def test_jinja_filters_registration(self):
        ...
        template = BaseReportTemplate(
            template_name="filter_test", template_type="economic"
        )
    ...
    def test_template_rendering_basic(self):
        ...
        template = BaseReportTemplate(
            template_name="render_test", template_type="economic"
        )
    ...
    def test_string_representation(self):
        ...
        template = BaseReportTemplate(
            template_name="repr_test", template_type="economic", version="1.2.3"
        )
