...
class TestProductionEfficiencyAnalysis:
    ...
    def test_add_production_optimization_tracking(self):
        ...
        try:
            ...
            water_cut_opportunity = any("High water cut" in opp for opp in opportunities)
            assert water_cut_opportunity
            
            # Should identify low well availability
            well_availability_opportunity = any("Low well availability" in opp for opp in opportunities)
