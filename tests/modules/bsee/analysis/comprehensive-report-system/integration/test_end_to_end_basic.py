...
class TestBasicEndToEnd:
    ...
    def test_basic_report_generation(
        self, sample_production_data, basic_config, temp_output_dir
    ):
        """Test basic report generation workflow."""
    ...
    def test_aggregator_functionality(self, sample_production_data):
        ...
        field_data = sample_production_data[
            sample_production_data["field"] == "Field_A"
        ]
        ...
        lease_data = sample_production_data[
            sample_production_data["lease"] == "LEASE001"
        ]
    ...
    def test_minimal_workflow(self, sample_production_data, temp_output_dir):
        ...
        try:
            ...
            # Aggregate data
            block_data = sample_production_data[
                sample_production_data["block"] == "MC 123"
            ]
