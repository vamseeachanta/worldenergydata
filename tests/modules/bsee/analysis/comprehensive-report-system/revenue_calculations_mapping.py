...
def create_price_deck_template():
    ...
    price_deck = {
        "base_prices": {
            ...
            "ngl": {"percentage_of_oil": 0.45, "unit": "fraction of oil price"},
        },
        "escalation": {
            "method": "inflation",
            "rate": 0.02,  # 2% annual
        ...
        "differentials": {
            ...
            "location": {"gulf_coast_differential": -2.00, "unit": "$/BBL"},
        },
    }
...
def create_cost_assumptions():
    ...
    cost_assumptions = {
        "operating_costs": {
            ...
            "transportation": {"pipeline": 3.00, "tanker": 5.00, "unit": "$/BBL"},
            "g&a": {"percentage_of_revenue": 0.03, "unit": "fraction"},
        },
        "capital_costs": {
            "drilling": {
            ...
            "completion": {"simple": 15000000, "complex": 35000000, "unit": "$/well"},
        },
        "tax_assumptions": {
