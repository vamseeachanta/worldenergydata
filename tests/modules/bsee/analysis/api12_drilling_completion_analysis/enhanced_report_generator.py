...
def generate_enhanced_comprehensive_report() -> str:
    ...
    methodology_data = {
        'lease_method': {
            ...
            'data_sources': ['WAR main binary files', 'Boreholes data', 'Properties data', 'Lease CSV']
        },
        'api12_method': {
            'approach': 'Milestone-based phase calculation through WellRigDays framework',
            'framework': 'WellRigDays integration',
            'data_sources': ['Structured well data', 'WellRigDays framework', 'Directional surveys', 'Borehole integration']
        }
    }
...
"""
    ...
    if conclusion_marker in base_report:
        ...
        enhanced_report = parts[0] + enhanced_sections + "\n" + conclusion_marker + parts[1]
    else:
