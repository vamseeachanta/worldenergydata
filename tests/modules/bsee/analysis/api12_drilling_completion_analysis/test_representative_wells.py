...
class TestRepresentativeWells:
    ...
    def test_comprehensive_summary_generation(self):
        ...
        print(f"  Range: {drilling_stats['min']:.1f} to {drilling_stats['max']:.1f} days")
        ...
        print(f"  Range: {completion_stats['min']:.1f} to {completion_stats['max']:.1f} days")
    ...
    def test_save_selected_wells_info(self):
        ...
        selected_wells_info = {
            ...
            "selected_wells": {
                "high_difference_well": {
                    "api12": int(summary['representative_wells']['high_difference']['api12']),
                    "field_name": summary['representative_wells']['high_difference']['field_name'],
                    "well_name": summary['representative_wells']['high_difference']['well_name'],
                    "total_difference": float(summary['representative_wells']['high_difference']['total_diff']),
                    "drilling_difference": float(summary['representative_wells']['high_difference']['drilling_diff']),
                    "completion_difference": float(summary['representative_wells']['high_difference']['completion_diff'])
                },
                "low_difference_well": {
                    "api12": int(summary['representative_wells']['low_difference']['api12']),
                    "field_name": summary['representative_wells']['low_difference']['field_name'],
                    "well_name": summary['representative_wells']['low_difference']['well_name'],
                    "total_difference": float(summary['representative_wells']['low_difference']['total_diff']),
                    "drilling_difference": float(summary['representative_wells']['low_difference']['drilling_diff']),
                    "completion_difference": float(summary['representative_wells']['low_difference']['completion_diff'])
                }
            },
            "analysis_summary": {
                "mean_drilling_diff": summary['overall_statistics']['drilling_diff']['mean'],
                "mean_completion_diff": summary['overall_statistics']['completion_diff']['mean'],
