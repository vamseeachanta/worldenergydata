...
class TestWellSelection:
    ...
    def sample_comparison_data(self):
        ...
        return pd.DataFrame({
            'api12': [608114062100, 608114062101, 608114063500, 608114063501, 608124003300],
    ...
    def large_comparison_data(self):
        ...
        api12_numbers = [api12_base + i*100 + np.random.randint(1, 99) for i in range(n_wells)]
        ...
        api12_completion = lease_completion + np.random.normal(0, 8, n_wells).astype(int)
    ...
    def test_find_high_difference_well(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.well_selector import find_high_difference_well
    ...
    def test_find_low_difference_well(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.well_selector import find_low_difference_well
    ...
    def test_select_representative_wells(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.well_selector import select_representative_wells
    ...
    def test_empty_dataset_handling(self):
        ...
        empty_data = pd.DataFrame(columns=['api12', 'total_diff', 'drilling_diff', 
                                          'completion_diff', 'well_name', 'field_name'])
    ...
    def test_get_well_details(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.well_selector import get_well_details
    ...
    def test_calculate_difference_statistics(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.well_selector import calculate_difference_statistics
    ...
    def test_filter_wells_by_criteria(self, large_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.well_selector import filter_wells_by_criteria
        
        # Filter wells with high drilling differences
        high_drilling_diff = filter_wells_by_criteria(
            large_comparison_data, 
            criteria={'drilling_diff': ('>', 10)}
        )
    ...
    def test_ranking_wells_by_difference(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.well_selector import rank_wells_by_difference
    ...
    def test_well_matching_validation(self, sample_comparison_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.well_selector import validate_well_selection
