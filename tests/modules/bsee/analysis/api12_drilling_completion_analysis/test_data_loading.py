...
class TestDataLoading:
    ...
    def sample_api12_data(self):
        ...
        return pd.DataFrame({
            ...
            'RIG_LAST_DATE_ON_WELL': ['5/31/2014', '8/6/2014 11:59:00 PM', '10/2/2013'],
            'Water Depth (feet)': [5230.0, 5228.0, 7015.0],
            'Total Measured Depth': [15356, 25800, 28567],
            'Drilling Days': [51, 46, 80],
            'Completion Days': [0, 0, 37],
            'rigdays_by_milestone': ['{"drilling_days": 63, "completion_days": 15, "rig_days": 78}',
    ...
    def test_load_lease_data_excel(self, temp_excel_file):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.data_loader import load_lease_data
        ...
        expected_columns = ['LEASE_NAME', 'API_WELL_NUMBER', 'DRILLING_DAYS', 'COMPLETION_DAYS']
    ...
    def test_load_api12_data_csv(self, temp_csv_file):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.data_loader import load_api12_data
    ...
    def test_validate_required_columns_lease(self, sample_lease_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.data_loader import validate_lease_columns
    ...
    def test_validate_required_columns_api12(self, sample_api12_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.data_loader import validate_api12_columns
    ...
    def test_data_standardization(self, sample_lease_data, sample_api12_data):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.data_loader import standardize_data
    ...
    def test_data_type_conversion(self):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.data_loader import convert_data_types
    ...
    def test_handle_missing_values(self):
        ...
        from tests.modules.bsee.analysis.api12_drilling_completion_analysis.data_loader import handle_missing_values
        ...
        assert not cleaned_df['API12'].isna().any()  # Should not have missing API12 values
