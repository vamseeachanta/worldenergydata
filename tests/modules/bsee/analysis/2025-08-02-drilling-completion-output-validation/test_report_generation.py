    ...
    def test_conclusion_generation(self):
        ...
        test_cases = [
            (
                100.0,
                "PERFECT MATCH",
                "The test output matches the original output exactly",
            ),
            (
                99.5,
                "EXCELLENT MATCH",
                "Minor differences detected that do not affect overall data quality",
            ),
            (95.0, "GOOD MATCH", "Some differences detected. Review recommended"),
            (
                85.0,
                "SIGNIFICANT DIFFERENCES",
                "Substantial differences found. Investigation required",
            ),
        ]
