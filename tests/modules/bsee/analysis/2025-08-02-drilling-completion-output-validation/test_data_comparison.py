...
class TestDataComparison:
    ...
    def test_cell_by_cell_comparison(self):
        ...
        df3 = pd.DataFrame({"A": [1, 2, 4], "B": ["x", "y", "z"]})  # Different value
    ...
    def test_date_comparison(self):
        ...
        df1 = pd.DataFrame({"date": pd.to_datetime(["2023-01-01", "2023-02-01"])})
        df2 = pd.DataFrame({"date": pd.to_datetime(["2023-01-01", "2023-02-01"])})
        df3 = pd.DataFrame(
