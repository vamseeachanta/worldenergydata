...
def test_enhanced_routing():
    ...
    try:
        ...
        print("   This should detect enhanced_refresh flag and route to DataRefreshEnhanced")
        ...
        if result_cfg:
            ...
            print(f"   [OK] Returned configuration has basename: {result_cfg.get('basename')}")
        else:
...
def test_legacy_routing():
    ...
    print(f"   - enhanced_refresh: {legacy_config['data'].get('enhanced_refresh', 'not set')}")
