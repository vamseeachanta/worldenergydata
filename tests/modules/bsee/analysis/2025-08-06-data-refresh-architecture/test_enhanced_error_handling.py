    ...
    def test_error_message_formatting(self):
        ...
        for error_msg in test_errors:
            ...
            has_useful_keyword = any(
                keyword.lower() in error_msg.lower() for keyword in useful_keywords
            )
            assert (
                has_useful_keyword
            ), f"Error message lacks useful keywords: {error_msg}"
...
class TestSystemCompatibility:
    ...
    def test_both_systems_can_coexist(self):
        ...
        assert (
            "enhanced" not in legacy_content.lower()
            or legacy_content != enhanced_content
        )
    ...
    def test_execution_path_independence(self):
        ...
        assert (
            'if __name__ == "__main__"' in legacy_content
            or "def main" in legacy_content
        )
        assert (
            'if __name__ == "__main__"' in enhanced_content
            or "def main" in enhanced_content
        )
