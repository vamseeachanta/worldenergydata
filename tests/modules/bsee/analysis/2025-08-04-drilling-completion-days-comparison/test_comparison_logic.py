...
class TestComparisonAnalyzer:
    ...
    def test_drilling_days_difference_calculation(
        self, sample_lease_data, sample_api12_data
    ):
    ...
    def test_completion_days_difference_calculation(
        self, sample_lease_data, sample_api12_data
    ):
    ...
    def test_discrepancy_flagging_logic(self, sample_lease_data, sample_api12_data):
        ...
        comparison_result = analyzer.calculate_drilling_days_differences(matched_data)
        comparison_result = analyzer.calculate_completion_days_differences(
            comparison_result
        )
