...
class TestMarkdownReportGenerator:
    ...
    def test_generate_markdown_table_structure(self, sample_comparison_data):
        ...
        assert (
            header_row.count("|") >= 6
        )  # 5 columns = 6 separators (including start/end)
    ...
    def test_file_output_with_custom_title(
        self, sample_comparison_data, temp_output_file
    ):
        ...
        generator.save_comparison_report(
            sample_comparison_data, temp_output_file, title=custom_title
        )
