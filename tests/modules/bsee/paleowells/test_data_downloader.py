...
class TestBSEEDataDownloader:
    ...
    def test_download_file_skip_existing(self, mock_get, downloader, temp_dir):
        ...
        result = downloader.download_file("http://test.com/file.zip", existing_file, overwrite=False)
    ...
    @patch('requests.get')
    def test_download_file_overwrite(self, mock_get, downloader, temp_dir, mock_response):
        ...
        result = downloader.download_file("http://test.com/file.zip", existing_file, overwrite=True)
    ...
    @patch('worldenergydata.modules.bsee.paleowells.data_downloader.BSEEDataDownloader.download_file')
    @patch('worldenergydata.modules.bsee.paleowells.data_downloader.BSEEDataDownloader.extract_zip')
    def test_download_dataset(self, mock_extract, mock_download, downloader, temp_dir):
    ...
    @patch('worldenergydata.modules.bsee.paleowells.data_downloader.BSEEDataDownloader.download_dataset')
