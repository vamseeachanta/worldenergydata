...
class TestRateLimiting:
    ...
    def fast_client(self):
        ...
        return SodirAPIClient(
            base_url="https://test.api", rate_limit=100  # 100 requests per second
        )
    ...
    def slow_client(self):
        ...
        return SodirAPIClient(
            base_url="https://test.api", rate_limit=2  # 2 requests per second
        )
...
class TestCaching:
    ...
    def client_with_cache(self):
        ...
        client = SodirAPIClient(
            base_url="https://test.api", rate_limit=10, cache_ttl=3600  # 1 hour
        )
