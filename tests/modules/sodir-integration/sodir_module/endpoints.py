...
SODIR_ENDPOINTS = {
    "blocks": {
        ...
        "fields": [
            "npdidBlock", "blockName", "blockArea", "blockStatus",
            "blockGeometry", "blockOperator", "blockLicensee"
        ]
    },
    "wellbores": {
        "id": "5000",
        ...
        "fields": [
            "npdidWellbore", "wellboreName", "wellboreType", "drillingOperator",
            "spudDate", "totalDepth", "waterDepth", "nsDeg", "ewDeg",
            "wellboreStatus", "wellborePurpose", "completionDate"
        ]
    },
    "fields": {
        "id": "7100",
        ...
        "fields": [
            "npdidField", "fieldName", "fieldOperator", "discoveryDate",
            "fieldStatus", "recoverableOil", "recoverableGas", "recoverableNGL",
            "recoverableCondensate", "productionStartYear"
        ]
    },
    "discoveries": {
        "id": "7000",
        ...
        "fields": [
            "npdidDiscovery", "discoveryName", "discoveryYear", "mainArea",
            "hydrocarbon", "resourceClass", "recoverableOilEstimate",
    ...
    "surveys": {
        ...
        "fields": [
            "npdidSurvey", "surveyName", "surveyType", "acquisitionYear",
            "surveyCompany", "surveyArea", "surveyGeometry"
        ]
    },
    "facilities": {
        "id": "3000",
        ...
        "fields": [
            "npdidFacility", "facilityName", "facilityType", "operator",
            "facilityStatus", "startupDate", "waterDepth"
        ]
    }
}
