...
class TestSodirDataRouter(unittest.TestCase):
    ...
    def test_collect_multiple_datasets(self):
        ...
        with patch.object(self.sodir_data.api_client, 'get_blocks') as mock_blocks, \
    ...
    def test_incremental_collection(self):
        ...
        with patch.object(self.sodir_data.api_client, 'get_fields') as mock_get:
            ...
            self.assertEqual(result['metadata']['filters']['since'], since_date.isoformat())
...
class TestDatasetGeneration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_fields = [
            {'field_name': 'JOHAN SVERDRUP', 'status': 'PRODUCING', 'oil_reserves': 2700},
    ...
    def test_summary_statistics(self):
        ...
        stats = self.generator.generate_statistics(
            fields=self.sample_fields
        )
