    ...
    def setUp(self):
        ...
        self.sample_block_data = {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[2.0, 58.0], [2.1, 58.0], [2.1, 58.1], [2.0, 58.1], [2.0, 58.0]]
                ],
            },
        }
...
class TestFieldProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_field_data = {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[2.0, 58.8], [2.2, 58.8], [2.2, 59.0], [2.0, 59.0], [2.0, 58.8]]
                ],
            },
        }
    ...
    def test_process_field_data(self):
        ...
        self.assertAlmostEqual(
            result["remaining_reserves_oil_mmbbl"], 11322.0, places=0
        )  # 1800 * 6.29
    ...
    def test_calculate_recovery_factors(self):
        ...
        self.assertAlmostEqual(
            result["recovery_factor_oil"], expected_recovery, places=3
        )
    ...
    def setUp(self):
        ...
        self.sample_survey_data = {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[2.0, 58.0], [2.5, 58.0], [2.5, 58.5], [2.0, 58.5], [2.0, 58.0]]
                ],
            },
        }
...
class TestCoordinateTransformation(unittest.TestCase):
    ...
    def test_round_trip_conversion(self):
        ...
        # Convert to WGS84
        lat, lon = self.transformer.utm_to_wgs84(
            original_easting, original_northing, utm_zone
        )

        # Convert back to UTM
        final_easting, final_northing, final_zone = self.transformer.wgs84_to_utm(
            lat, lon
        )
...
class TestDataValidation(unittest.TestCase):
    ...
    def test_validate_required_fields(self):
        ...
        schema = {"required": ["field1", "field2"], "optional": ["field3"]}
    ...
    def test_validate_data_types(self):
        ...
        schema = {"fields": {"name": str, "year": int, "value": float, "items": list}}

        valid_data = {"name": "Test", "year": 2023, "value": 123.45, "items": [1, 2, 3]}
        ...
        invalid_data = {
            "name": "Test",
            "year": "not_a_year",
        }  # year should be int and not convertible
    ...
    def test_validate_coordinate_ranges(self):
        ...
        is_valid = self.validator.validate_norwegian_coordinates(
