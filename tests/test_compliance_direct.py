"""
Direct test of ComplianceTemplate without dependency issues
"""
...
def test_compliance_visualizations():
    ...
    try:
        template = ComplianceTemplate(
            template_name="compliance_report", template_path=template_path
        )
...
if __name__ == "__main__":
    print("Running ComplianceTemplate tests...")
