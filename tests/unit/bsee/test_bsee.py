...
class TestBSEE:
    ...
    def test_router_without_analysis_key(self, mock_bsee_data, mock_bsee_analysis):
        ...
        cfg = {"basename": "bsee", "data": {"test_data": "value"}}
    ...
    def test_router_data_copy(self, mock_bsee_data, mock_bsee_analysis):
        ...
        cfg = {"basename": "bsee", "data": original_data, "analysis": original_analysis}
...
class TestBSEEIntegration:
    ...
    def test_global_instances(self):
        ...
        from worldenergydata.bsee.bsee import bsee_analysis, bsee_data
