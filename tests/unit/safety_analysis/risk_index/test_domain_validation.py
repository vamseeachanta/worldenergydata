...
class TestMoreIncidentsHigherRisk:
    ...
    def test_more_incidents_higher_composite(self):
        rows = [
            {
                "activity_code": "FIELD_A",
                "activity_name": "Field A",
                "total_incidents": 100,
                "fatalities": 5,
                "injuries": 20,
                "fatality_rate": 0.05,
            ...
            {
                "activity_code": "FIELD_B",
                "activity_name": "Field B",
                "total_incidents": 10,
                "fatalities": 0,
                "injuries": 1,
                "fatality_rate": 0.0,
                "injury_rate": 0.10,
                "tri_carcinogen_lbs": 50.0,
                "inc_rate": 0.05,
                "confidence": "low",
                "sources": ["bsee"],
    ...
    def test_more_incidents_higher_acute(self):
        rows = [
            {
                "activity_code": "A",
                "activity_name": "High Freq",
                "total_incidents": 200,
                "fatalities": 10,
                "injuries": 50,
                "fatality_rate": 0.05,
                "injury_rate": 0.25,
                "tri_carcinogen_lbs": 0.0,
                "inc_rate": 0.0,
                "confidence": "high",
                "sources": ["bsee"],
...
class TestFatalitiesHigherThanInjuries:
    ...
    def test_fatality_activity_scores_higher_acute(self):
        rows = [
            ...
            {
                "activity_code": "NONFATAL",
                "activity_name": "No Fatalities",
                "total_incidents": 50,
                "fatalities": 0,
                "injuries": 10,
                "fatality_rate": 0.0,
...
class TestComplianceViolations:
    ...
    def test_high_inc_rate_higher_compliance(self):
        rows = [
            {
                "activity_code": "HIGH_INC",
                "activity_name": "Many Violations",
                "total_incidents": 50,
                "fatalities": 0,
                "injuries": 0,
                "fatality_rate": 0.0,
            ...
            {
                "activity_code": "LOW_INC",
                "activity_name": "Few Violations",
                "total_incidents": 50,
                "fatalities": 0,
                "injuries": 0,
                "fatality_rate": 0.0,
...
class TestEdgeCases:
    ...
    def test_all_fatalities_maximum_severity(self):
        rows = [
            {
                "activity_code": "ALL_FATAL",
                "activity_name": "All Fatal",
                "total_incidents": 10,
                "fatalities": 10,
                "injuries": 0,
                "fatality_rate": 1.0,
            ...
            {
                "activity_code": "NO_FATAL",
                "activity_name": "No Fatal",
                "total_incidents": 10,
                "fatalities": 0,
                "injuries": 0,
                "fatality_rate": 0.0,
...
class TestConfigurableWeights:
    ...
    def test_higher_acute_weight_shifts_composite(self):
        ...
        rows = [
            {
                "activity_code": "HIGH_ACUTE",
                "activity_name": "High Acute",
                "total_incidents": 100,
                "fatalities": 10,
                "injuries": 30,
                "fatality_rate": 0.10,
                "injury_rate": 0.30,
                "tri_carcinogen_lbs": 10.0,
                "inc_rate": 0.02,
                "confidence": "high",
                "sources": ["bsee"],
                "weighted_incident_count": 30.0,
            ...
            {
                "activity_code": "LOW_ACUTE",
                "activity_name": "Low Acute",
                "total_incidents": 10,
                "fatalities": 0,
                "injuries": 0,
                "fatality_rate": 0.0,
        ...
        def_high = next(
            s for s in default_result.scores if s.activity_code == "HIGH_ACUTE"
        )
        def_low = next(
            s for s in default_result.scores if s.activity_code == "LOW_ACUTE"
        )
        cust_high = next(
            s for s in custom_result.scores if s.activity_code == "HIGH_ACUTE"
        )
        cust_low = next(
            s for s in custom_result.scores if s.activity_code == "LOW_ACUTE"
        )
        ...
        assert (
            ...
            or cust_high.composite_score >= def_high.composite_score
        )
