...
class TestCreateComparisonDashboard:
    ...
    def test_custom_metrics(self):
        ...
        sodir = {}
        bsee = {}
        dashboard = viz.create_comparison_dashboard(
            sodir, bsee, metrics=["production_rate"]
        )
    ...
    def test_layout_selection(self):
        ...
        d6 = viz.create_comparison_dashboard(
            sodir, bsee, metrics=["a", "b", "c", "d", "e", "f"]
        )
        assert d6.layout == (2, 3)
        # 7+ metrics -> (3,3) layout
        d7 = viz.create_comparison_dashboard(
            sodir, bsee, metrics=["a", "b", "c", "d", "e", "f", "g"]
        )
