...
from tests.test_markers import performance, smoke, unit
...
class TestNPVAnalysis:
    ...
    @pytest.mark.skip(
        reason="Copilot module does not exist - legacy test for removed feature"
    )
    ...
    def test_load_actual_excel_data_success(self, mock_read_excel, mock_exists):
        ...
        sys.path.insert(
            ...
            os.path.join(
                ...
                "../../../modules/bsee/analysis/custom_scripts",
            ),
        )
