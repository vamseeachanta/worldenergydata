...
class TestOutputDir:
    ...
    def test_nonexistent_output_dir_is_created(self, simple_result, tmp_dir):
        ...
        manifest = export_report(simple_result, formats=["csv"], output_dir=new_dir)
...
class TestXlsxExport:
    def test_xlsx_file_created(self, simple_result, tmp_dir):
        manifest = export_report(simple_result, formats=["xlsx"], output_dir=tmp_dir)
...
class TestParquetExport:
    def test_parquet_file_created(self, simple_result, tmp_dir):
        manifest = export_report(simple_result, formats=["parquet"], output_dir=tmp_dir)
...
class TestCsvExport:
    def test_csv_file_created(self, simple_result, tmp_dir):
        manifest = export_report(simple_result, formats=["csv"], output_dir=tmp_dir)
...
class TestJsonExport:
    def test_json_file_created(self, simple_result, tmp_dir):
        manifest = export_report(simple_result, formats=["json"], output_dir=tmp_dir)
...
class TestPdfHtmlFallback:
    def test_pdf_produces_html_file(self, simple_result, tmp_dir):
        manifest = export_report(simple_result, formats=["pdf"], output_dir=tmp_dir)
...
class TestFailureIsolation:
    def test_unsupported_format_goes_to_formats_failed(self, simple_result, tmp_dir):
        manifest = export_report(
    ...
    def test_unsupported_format_does_not_block_others(self, simple_result, tmp_dir):
        manifest = export_report(
            simple_result,
    ...
    def test_formats_failed_contains_error_message(self, simple_result, tmp_dir):
        manifest = export_report(
    ...
    def test_files_dict_only_contains_succeeded_formats(self, simple_result, tmp_dir):
        manifest = export_report(
