...
class TestOilUnits:
    ...
    def test_bbl_to_tonne_is_inverse_of_tonne_to_bbl(self):
        from worldenergydata.common.units import OilUnits
        assert OilUnits.BBL_TO_TONNE == pytest.approx(1.0 / OilUnits.TONNE_TO_BBL, rel=1e-4)
...
class TestGasUnits:
    ...
    def test_sm3_to_mmscf_is_sm3_to_scf_times_1e_minus6(self):
        from worldenergydata.common.units import GasUnits
        assert GasUnits.SM3_TO_MMSCF == pytest.approx(GasUnits.SM3_TO_SCF * 1e-6, rel=1e-6)
    ...
    def test_mcf_to_mmscf_is_inverse_of_mmscf_to_mcf(self):
        from worldenergydata.common.units import GasUnits
        assert GasUnits.MCF_TO_MMSCF == pytest.approx(1.0 / GasUnits.MMSCF_TO_MCF, rel=1e-6)
...
class TestPressureUnits:
    ...
    def test_bar_to_psi_is_inverse(self):
        from worldenergydata.common.units import PressureUnits
        assert PressureUnits.BAR_TO_PSI == pytest.approx(1.0 / PressureUnits.PSI_TO_BAR, rel=1e-4)
...
class TestConvertScalar:
    ...
    def test_large_value_converts_linearly(self):
        from worldenergydata.common.units import convert, OilUnits
        value = 1_000_000.0
...
class TestConvertSeries:
    ...
    def test_series_sm3_to_bbl(self):
        from worldenergydata.common.units import convert_series, OilUnits
    ...
    def test_series_psi_to_bar(self):
        from worldenergydata.common.units import convert_series, PressureUnits
    ...
    def test_series_msm3_to_mmscf(self):
        from worldenergydata.common.units import convert_series, GasUnits
