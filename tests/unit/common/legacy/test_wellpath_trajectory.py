...
class TestSurveyPoint:
    def test_named_tuple(self):
        sp = SurveyPoint(
            depth=100.0, inc=5.0, azi=180.0,
            tvd=99.9, north=0.5, east=0.0,
            closure=0.5, dls=2.0,
        )
...
class TestCalculateMinimumCurvature:
    def test_zero_course_length(self):
        result = calculate_minimum_curvature(
            depth1=100, inc1=0, azi1=0,
            tvd1=100, north1=0, east1=0,
            depth2=100, inc2=0, azi2=0,
        )
    ...
    def test_negative_course_length(self):
        result = calculate_minimum_curvature(
            depth1=200, inc1=0, azi1=0,
            tvd1=200, north1=0, east1=0,
            depth2=100, inc2=0, azi2=0,
        )
    ...
    def test_vertical_well(self):
        result = calculate_minimum_curvature(
            depth1=0, inc1=0, azi1=0,
            tvd1=0, north1=0, east1=0,
            depth2=100, inc2=0, azi2=0,
        )
    ...
    def test_inclined_well(self):
        result = calculate_minimum_curvature(
            depth1=0, inc1=30, azi1=0,
            tvd1=0, north1=0, east1=0,
            depth2=100, inc2=30, azi2=0,
        )
    ...
    def test_closure_distance(self):
        result = calculate_minimum_curvature(
            depth1=0, inc1=45, azi1=45,
            tvd1=0, north1=0, east1=0,
            depth2=100, inc2=45, azi2=45,
        )
...
class TestInterpolateSurveyPoint:
    def test_at_upper_point(self):
        inc, azi, tvd, north, east, depth_from = interpolate_survey_point(
            upper_depth=0, upper_inc=0, upper_azi=0,
            upper_tvd=0, upper_north=0, upper_east=0,
            lower_depth=100, lower_inc=10, lower_azi=90,
            target_depth=0,
        )
        assert tvd == 0
        assert north == 0
    ...
    def test_building_inclination(self):
        inc, _, _, _, _, _ = interpolate_survey_point(
            upper_depth=0, upper_inc=0, upper_azi=0,
            upper_tvd=0, upper_north=0, upper_east=0,
            lower_depth=100, lower_inc=30, lower_azi=0,
            target_depth=50,
        )
    ...
    def test_dropping_inclination(self):
        inc, _, _, _, _, _ = interpolate_survey_point(
            upper_depth=0, upper_inc=30, upper_azi=0,
            upper_tvd=0, upper_north=0, upper_east=0,
            lower_depth=100, lower_inc=0, lower_azi=0,
            target_depth=50,
        )
    ...
    def test_same_depth_stations(self):
        ...
        inc, azi, tvd, north, east, depth_from = interpolate_survey_point(
            upper_depth=100, upper_inc=0, upper_azi=0,
            upper_tvd=100, upper_north=0, upper_east=0,
            lower_depth=100, lower_inc=10, lower_azi=90,
            target_depth=100,
        )
