...
class TestAPIDiscovery:
    ...
    def test_noaa_weather_api_endpoints(self):
        ...
        office = "TOP"
        gridX, gridY = 31, 80
        forecast_url = endpoints["forecast"].format(
            office=office, gridX=gridX, gridY=gridY
        )
    ...
    def test_authentication_requirements(self):
        ...
        auth_requirements = {
            "bsee_arcgis": {"required": False, "type": None},
            "eia": {
                "required": True,
                "type": "api_key",
                "location": "query",
            ...
            "noaa_ncei": {"required": False, "type": None},
            "noaa_weather": {"required": False, "type": None},
            "noaa_cdo": {
                "required": True,
                "type": "token",
                "location": "header",
            ...
            "uswtdb": {"required": False, "type": None},
            "nrel": {
                "required": True,
                "type": "api_key",
                "location": "query",
    ...
    def test_rate_limit_specifications(self):
        ...
        rate_limits = {
            "eia": {"requests_per_day": 10000, "requests_per_second": None},
            "noaa_cdo": {"requests_per_day": 10000, "requests_per_second": 5},
            "bsee_arcgis": {
    ...
    def test_spatial_query_capabilities(self):
        ...
        spatial_support = {
            ...
            "eia": {"supported": False, "query_types": []},
        }
    ...
    def test_error_response_handling(self):
        ...
        error_scenarios = {
            ...
            "auth_failed": {"status_code": 401, "message": "Invalid API key"},
            "not_found": {"status_code": 404, "message": "Endpoint not found"},
