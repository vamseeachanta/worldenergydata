...
class TestCompletenessValidation:
    ...
    def test_validate_completeness_checks_required_fields(self, validator, db_session):
        ...
        assert result['required_fields_completeness'] == 100.0  # All required fields present
...
class TestRangeValidation:
    ...
    def test_validate_ranges_checks_penalty_amount_positive(self, validator, db_session):
    ...
    def test_validate_ranges_checks_incident_counts_non_negative(self, validator, db_session):
...
class TestConsistencyValidation:
    ...
    def test_validate_consistency_checks_facility_location_alignment(self, validator, db_session):
    ...
    def test_validate_consistency_checks_compliance_penalty_alignment(self, validator, db_session):
...
class TestOutlierDetection:
    ...
    def test_detect_outliers_identifies_extreme_incident_counts(self, validator, db_session):
...
class TestTemporalValidation:
    ...
    def test_validate_temporal_checks_incident_date_not_too_old(self, validator, db_session):
    ...
    def test_validate_temporal_checks_compliance_deadline_after_incident(self, validator, db_session):
...
class TestRunAllValidations:
    ...
    def test_run_all_validations_calculates_overall_quality_score(self, validator, db_session):
    ...
    def test_run_all_validations_returns_summary_statistics(self, validator, db_session):
    ...
    def test_run_all_validations_stores_results_in_instance(self, validator, db_session):
