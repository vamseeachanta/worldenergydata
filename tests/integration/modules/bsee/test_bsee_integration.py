...
class TestBSEEAnalysisIntegration:
    ...
    def test_data(self):
        ...
        return {
            'well_data': pd.DataFrame({
                ...
                'SPUD_DATE': pd.to_datetime(['2014-03-15', '2014-06-20', '2015-01-10']),
                'COMPLETION_DATE': pd.to_datetime(['2014-09-20', '2014-12-15', '2015-07-25'])
            }),
            'production_data': pd.DataFrame({
                'API12': ['608124003301', '608124003301', '608124003302', '608124003302'],
                'PRODUCTION_DATE': pd.to_datetime(['2020-01-01', '2020-02-01', '2020-01-01', '2020-02-01']),
    ...
    def test_run_analysis_for_all_wells_integration(self, mock_prod, mock_well, test_config, test_data):
        ...
        mock_prod.run_production_analysis.return_value = (test_config, prod_analysis_result)
    ...
    def test_add_production_dates_integration(self, test_data):
...
class TestBSEEDataProcessing:
    ...
    def test_well_data_processing(self, sample_well_data):
        ...
        processed['TVD'] = processed['DEPTH'] * np.cos(np.radians(processed['INCLINATION']))
        processed['HORIZONTAL_DISPLACEMENT'] = processed['DEPTH'] * np.sin(np.radians(processed['INCLINATION']))
    ...
    def test_production_timeline_creation(self):
        ...
        assert production['cumulative_oil'].iloc[-1] > production['cumulative_oil'].iloc[0]
