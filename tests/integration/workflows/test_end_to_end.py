...
class TestCompleteWorkflow:
    ...
    def complete_config(self, tmp_path):
        ...
        config = {
            ...
            'parameters': {
                'filepath': {
                    'apm': {
                        'bin': str(tmp_path / 'test_data' / 'bin')
                    },
                    'data': {
    ...
    def test_complete_bsee_workflow(self, mock_bsee_class, complete_config, test_data_files):
    ...
    @patch('worldenergydata.modules.bsee.bsee.bsee')
    def test_yaml_to_output_workflow(self, mock_bsee_class, mock_yaml, complete_config, tmp_path):
        ...
        mock_yaml_instance.ymlInput.return_value = config
...
class TestDataPipelineIntegration:
    ...
    def test_data_ingestion_pipeline(self, tmp_path):
        ...
        transformed_data['value_normalized'] = transformed_data['value'] / transformed_data['value'].max()
...
class TestErrorHandlingIntegration:
    ...
    def test_missing_data_handling(self, tmp_path):
        ...
        with patch('worldenergydata.modules.bsee.bsee.bsee') as mock_bsee:
    ...
    def test_partial_data_processing(self):
        ...
        assert filled['value'].iloc[1] == 0 if pd.isna(cleaned['value'].iloc[1]) else cleaned['value'].iloc[1]
...
class TestPerformanceIntegration:
    ...
    def test_workflow_performance(self, benchmark):
