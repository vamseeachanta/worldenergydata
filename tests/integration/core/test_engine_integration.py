...
from tests.integration.test_config_helper import get_complete_test_config, get_minimal_test_config
...
class TestEngineIntegration:
    ...
    @patch('worldenergydata.modules.bsee.bsee.bsee')
    ...
    @patch('worldenergydata.modules.bsee.zip_data_dwnld.zip.zip')
    ...
    @patch('worldenergydata.modules.bsee.custom_router.CustomRouter')
    def test_engine_custom_router_real_execution(self, mock_custom_class):
        ...
        assert result is not None
        assert result['basename'] == 'bsee_custom'
    ...
    def test_engine_with_config_flag_true(self, mock_result_folder, mock_configure, mock_fm):
        ...
        with patch('worldenergydata.modules.bsee.bsee.bsee') as mock_bsee_class:
            mock_instance = MagicMock()
            mock_bsee_class.return_value = mock_instance
            mock_instance.router.return_value = self.test_cfg
    ...
    @patch('worldenergydata.modules.bsee.bsee.bsee')
    def test_engine_with_yaml_input_file(self, mock_bsee_class, mock_yaml_class):
        ...
        mock_yaml_instance.ymlInput.return_value = self.test_cfg
        ...
        assert result is not None
        assert result['basename'] == 'bsee'
        mock_yaml_instance.ymlInput.assert_called_once()
...
class TestEngineDataFlow:
    ...
    @patch('worldenergydata.modules.bsee.bsee.bsee')
    def test_engine_logging_integration(self, mock_bsee_class, mock_logger, sample_data_cfg):
