...
> Complete guide to using WorldEnergyData for energy analysis
> Last Updated: 2025-07-24

## Welcome to the WorldEnergyData User Guide

This guide provides comprehensive documentation for energy professionals, data analysts, and researchers using WorldEnergyData for energy industry analysis.

## Getting Started

### New to WorldEnergyData?

If you're new to WorldEnergyData, we recommend following this learning path:

1. **[Getting Started](getting-started/)** - Learn the basics and set up your first analysis
2. **[Installation](installation/)** - Detailed installation instructions for different environments
3. **[Quick Examples](quick-examples/)** - Common usage patterns and code snippets
4. **[API Reference](api-reference/)** - Complete documentation of all functions and classes

### Quick Navigation

| Section | Description | Best For |
|---------|-------------|----------|
| [Getting Started](getting-started/) | Basic concepts and first steps | New users |
| [Installation](installation/) | Setup and configuration | System administrators |
| [Quick Examples](quick-examples/) | Code snippets and patterns | Developers |
| [API Reference](api-reference/) | Complete function documentation | Reference lookup |
...
- **Wind**: Wind energy databases and analysis
...
*Ready to start? Head to [Getting Started](getting-started/) to begin your WorldEnergyData journey.*