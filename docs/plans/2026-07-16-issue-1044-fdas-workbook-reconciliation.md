...
- The D&C workbook will be frozen at SHA-256 `3ecfa1128b33edf73db3a793f8839c98c50bc27184487a8af579c5ef22795e7f`; workbook core metadata will be excluded from publishable inventories.
...
6. Variance classification and resolution will be separate. Classification will require evidence; material unsupported or missing-evidence differences will fail closed. Materiality will be `max($25MM, 1% of the compatible workbook total)`, with the denominator persisted.
...
variance = workbook_lane - compatible_comparison_lane
if material and resolution unsupported_or_missing_evidence: fail
