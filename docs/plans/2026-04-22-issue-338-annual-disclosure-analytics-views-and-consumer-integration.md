...
- `src/worldenergydata/fdas/__init__.py` uses lazy export patterns for public consumer APIs.
- `src/worldenergydata/fdas/api.py` provides query-style consumer surface patterns.
- `src/worldenergydata/lower_tertiary/npv.py` consumes normalized dict/DataFrame inputs and is the natural place for optional disclosure-view consumption hooks.
