...
python -m worldenergydata.bsee.paleowells process \
    --input-file raw_data.txt \
    --output-directory ./output \
    --analyze

# Download BSEE/BOEM data
python -m worldenergydata.bsee.paleowells download \
    --datasets borehole company \
    --extract \
    --data-directory ./data

# Get info about available datasets
python -m worldenergydata.bsee.paleowells download --info

# Visualize paleowells data
python -m worldenergydata.bsee.paleowells visualize \
